...
public class Surtido_Menu_Docificacion extends AppCompatActivity
{
    String PartidaERP;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try {
            ...
            new cambiaColorStatusBar(contexto, R.color.MoradoStd, Surtido_Menu_Docificacion.this);
            ArrayList<constructorTablaMenuPrincipal> lista = new ArrayList<>();



            int icono1=  R.drawable.icono_surt_v5_surtido;
            int icono2= R.drawable.iconobascula;
            int icono3 = R.drawable.iconobascula;


            constructorTablaMenuPrincipal Proveedor = new constructorTablaMenuPrincipal(icono1, getString(R.string.por_empaque), "");
            constructorTablaMenuPrincipal Maquila = new constructorTablaMenuPrincipal(icono2, getString(R.string.Embarques_Surtido_docificacion), "");
            constructorTablaMenuPrincipal e2= new constructorTablaMenuPrincipal(icono3, getString(R.string.Embarques_Surtido_docificacion), "");
            ...
            listaMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    switch (position) {
                        case 0:
                            intent = new Intent(Surtido_Menu_Docificacion.this, Surtido_Docificacion_PorEmpaque.class);

                            break;
                        case 1:
                            //intent = new Intent(Surtido_Menu_Docificacion.this, Bascula_Pesaje.class);
                            intent = new Intent(Surtido_Menu_Docificacion.this, Surtido_Docificacion.class);
...
//                sp.execute();
            ...
            adaptadorTablaMenuPrincipal adaptador = new adaptadorTablaMenuPrincipal(Surtido_Menu_Docificacion.this, R.layout.menu_item, lista);
