...
public class Surtido_Ajuste_Docificacion extends AppCompatActivity
{
    //region variables
    String TAG = Surtido_Ajuste_Docificacion.class.getSimpleName();
    Button btn_enviar,btn_CerrarTarima;
    SoapAction sa = new SoapAction();
    FrameLayout progressBarHolder;
    Context contexto = this;
    EditText edtx_OrdenProd,edtx_Pesaje,edtx_Bascula,edtx_CodigoEmpaque,edtx_Tara;
    View vista ;
    Handler h;
    HiloDatosTCP hrd;
    Spinner spnr_Areas;
    ...
    String Pedido, Partida, NumParte, UM, CantidadTotal, CantidadPendiente, CantidadSurtida, Area,AreaDesc, CodigoPallet,Lote;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_bascula_ajuste_docificacion);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        new cambiaColorStatusBar(contexto, R.color.MoradoStd, Surtido_Ajuste_Docificacion.this);

        // TipoPesaje = "Automatico";

        try {
            getSupportActionBar().setTitle(getString(R.string.ajuste_docificacion));
            SacaExtrasIntent();
            ...
            {
                new cambiaColorStatusBar(contexto, R.color.doradoLetrastd, Surtido_Ajuste_Docificacion.this);
    ...
    private void declaraVariables()
    {
        try {
         ...
         //   btn_CerrarTarima = (Button) findViewById(R.id.btn_CerrarTarima);
            ...
            edtx_Tara = (EditText) findViewById(R.id.edtx_Tara);
...
//            txtv_Area.setText(AreaDesc);
    ...
    private void agregaListeners()
    {
        ...
        edtx_Tara.setOnFocusChangeListener(new View.OnFocusChangeListener()
        {
            @Override
            public void onFocusChange(View v, boolean hasFocus)
            {
                ...
                if(hasFocus&&edtx_Tara.getText().toString().equals("0"))
                {
                    try
                    {
                        edtx_Tara.setText("");
        ...
        btn_enviar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                try
                {
                    ...
                    if(edtx_Tara.getText().toString().equals(""))
                    {
                        new popUpGenerico(contexto,getCurrentFocus(),getString(R.string.error_ingrese_tara),"false" ,true ,true );
                        edtx_Tara.setText("");
                        edtx_Tara.requestFocus();
                        return;
                    }
//
        ...
        edtx_CodigoEmpaque.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    new esconderTeclado(Surtido_Ajuste_Docificacion.this);
                }
                return false;
            }
        });
            ...
            try
            {
                switch (tarea)
                {
                    ...
                    case "RegistrarPesaje":
                        ...
                        sa.SOAPAjusteEmpaqueNuevoDocificacion(edtx_CodigoEmpaque.getText().toString(),edtx_Tara.getText().toString(),peso,contexto);

                        Log.i("SoapResponse",Pedido+" "+Partida+" empaque-"+edtx_CodigoEmpaque.getText().toString()+" peso -"+peso);
                        break;
                        default:
                            decision = "false";
                            mensaje = "Operación no registrada" + tarea;
                            break;
                    case"ConsultaAreas":
                    ...
                    switch (tarea)
                    {
                        ...
                        case "ConsultaAreas":
                            ...
                            spinnerAdapter= new ArrayAdapter<String>(
                                    Surtido_Ajuste_Docificacion.this,
                            ...
                            if(AreaDesc!=null)
                            {
                                spnr_Areas.setSelection(((ArrayAdapter) spinnerAdapter).getPosition(AreaDesc));
                            }
                            break;
            ...
            new AlertDialog.Builder(this).setIcon(R.drawable.ic_warning_black_24dp)
                    ...
                    .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            terminarPesaje();
                            Surtido_Ajuste_Docificacion.super.onBackPressed();
                        }
                    })
