...
public class Surtido_Docificacion extends AppCompatActivity
{
    //region variables
    String TAG = Surtido_Docificacion.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new cambiaColorStatusBar(contexto, R.color.MoradoStd, Surtido_Docificacion.this);
                            ...
                            if(!(arrayDatosTabla.size()<=0))
                            {
                                ...
                                new CreaDialogos(getString(R.string.pregunta_cierre_pallet), new DialogInterface.OnClickListener()
                                {
                                    public void onClick(DialogInterface dialog, int id) {
                                        ...
                                        sp.execute();
                                        new esconderTeclado(Surtido_Docificacion.this);
                                    }
                                },null,contexto);
                            }
                            else
                ...
                if ((id == R.id.ReimprimeEtiqueta))
                    {
                      ...
                      //  Thread.sleep(100);
                        ...
                        Intent intent = new Intent(Surtido_Docificacion.this,Surtido_ReimpresionEtiqueta.class);
                        intent.putExtras(bundlefragment);
                        startActivity(intent);


//                        inputDialogFragment = new InputDialogFragment();
//                        inputDialogFragment.setArguments(bundlefragment);
//                        inputDialogFragment.show(getSupportFragmentManager(), "Dialogo input");
                ...
                try
                {
                    switch (tarea)
                    {
                        ...
                        case "RegistrarPesaje":
                            ...
                            sa.SOAPSurtirPiezas(Pedido,Partida,edtx_CodigoEmpaque.getText().toString(),peso,Area,contexto);
                   ...
                   //         sa.SOAPSurtirPiezas2(Pedido,Partida,edtx_CodigoEmpaque.getText().toString(),peso,Area,contexto);
                        ...
                        case "CerrarPesaje":
                            ...
                            break;
                        case "CerrarTarima":
                            sa.SOAPCierraTarimaConsolidadaOP(Pedido,RegEmpPalletAbierto,contexto);
                            break;
                            ...
                            switch (tarea)
                                {
                                  ...
                                  //      new popUpGenerico(contexto,getCurrentFocus(),decision,decision,true,true);
                                        ...
                                        tabla_Salidas.getDataAdapter().notifyDataSetChanged();
                                        tabla_Salidas.setDataAdapter(st = new SimpleTableDataAdapter(Surtido_Docificacion.this, DATA_TO_SHOW));
                                        ReiniciarTabla = true;
                                    ...
                                    case "CerrarTarima":
                                        new popUpGenerico(contexto,getCurrentFocus(),"Pallet ["+mensaje+"] cerrado con exito.k",decision,true,true);
        ...
        try
        {
            new AlertDialog.Builder(this).setIcon(R.drawable.ic_warning_black_24dp)
                    ...
                    .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                          terminarPesaje();
                            Surtido_Docificacion.super.onBackPressed();
                        }
                    })
