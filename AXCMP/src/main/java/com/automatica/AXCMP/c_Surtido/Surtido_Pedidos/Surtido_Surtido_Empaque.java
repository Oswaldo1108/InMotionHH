...
public class Surtido_Surtido_Empaque extends AppCompatActivity
{
    //region variables
    ...
    String RegEmpCantidadPedida, RegEmpCantidadSurtida, RegEmpCantidadPendiente, RegEmpStatus, RegEmpPalletAbierto;
            ...
            try
            {
                ...
                switch (tarea)
                {
                    ...
                    case "RegistrarEmpaque":
                        ...
                        sa.SOAPRegistraEmpaqueSurtido(Pedido,Partida, edtx_ConfirmarEmpaque.getText().toString(),contexto);
                        break;
                            ...
                            switch (tarea)
                                {
                                    ...
                                    case "ConsultaPalletAbierto":
                                        tabla_Salidas.getDataAdapter().notifyDataSetChanged();
                                        tabla_Salidas.setDataAdapter(st = new SimpleTableDataAdapter(Surtido_Surtido_Empaque.this, DATA_TO_SHOW));
                                        ReiniciarTabla = true;
                                    ...
                                    case "RegistrarEmpaque":
                                        txtv_CantPend.setText(RegEmpCantidadPendiente);
