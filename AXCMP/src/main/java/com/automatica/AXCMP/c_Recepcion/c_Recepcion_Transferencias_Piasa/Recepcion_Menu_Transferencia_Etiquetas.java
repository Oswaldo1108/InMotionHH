...
public class Recepcion_Menu_Transferencia_Etiquetas extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new cambiaColorStatusBar(contexto,R.color.VerdeStd, Recepcion_Menu_Transferencia_Etiquetas.this);
        ArrayList<constructorTablaMenuPrincipal> lista = new ArrayList<>();


            int iconoAlmacen =  R.drawable.icono_rec_v5_registro_empaque;
            int iconoConsultas = R.drawable.icono_rec_v5_registro_empaque;
