...
public class Recepcion_Registro_PrimerasYUltimas_Spinner extends AppCompatActivity
{
    ...
    TextView txtv_EmpaquesRegistrados, txtv_OrdenCompra,txtv_Partida,txtv_UM,txtv_CantidadOriginal,txtv_CantidadRegistrada,txtv_Producto,txtv_Pallet,txtv_CantidadLote,txtv_CantRegLote;
    Bundle b;
    View vista;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try {
            ...
            new cambiaColorStatusBar(contexto, R.color.VerdeStd, Recepcion_Registro_PrimerasYUltimas_Spinner.this);
            SacaExtrasIntent();
            declararVariables();
            AgregaListeners();
    ...
    private void declararVariables()
    {
        try {
            ...
            txtv_CantRegLote = (TextView) findViewById(R.id.txtv_CantidadLote);
            txtv_CantidadLote = (TextView) findViewById(R.id.txtv_RegLote);
                                        ...
                                        if(!(Float.parseFloat(edtx_Cantidad.getText().toString()) <=0))
                                            {
                                                if(!ArrayLotes.isEmpty())
                                                    {
                                                        Log.i("SoapResponse","ListaLotes:  "+ListaLotes.get(spnr_OrdenesCompra.getSelectedItemPosition()).getLoteAXC());
                                                        sa.SOAPRegistraMPPrimerasYUltimas(OrdenCompra, PartidaERP, ListaLotes.get(spnr_OrdenesCompra.getSelectedItemPosition()).getLoteAXC(), Cantidad, EmpaquesPallet, PrimerEmpaque, UltimoEmpaque, CantidadEmpaques, contexto);
                                                        mensaje = sa.getMensaje();
                                                        decision = sa.getDecision();
                                                    }else
                                                    {
                            ...
                            switch (tarea)
                                {
                                    ...
                                    case "ListarOrdenesCompra":
                                        ...
                                        spinnerAdapter= new ArrayAdapter<String>(
                                                Recepcion_Registro_PrimerasYUltimas_Spinner.this,
