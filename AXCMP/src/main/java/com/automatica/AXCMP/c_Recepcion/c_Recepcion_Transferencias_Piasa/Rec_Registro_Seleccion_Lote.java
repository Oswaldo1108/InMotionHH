...
public class Rec_Registro_Seleccion_Lote extends AppCompatActivity
{
    //region variables
    ...
    String[] HEADER = {"Partida","Origen","Producto","Lote","Cant. Solicitada","Cant. Recibida","Cant. Pendiente","Fecha Producción","Fecha Caducidad"};
    String[][] DATA_TO_SHOW;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new cambiaColorStatusBar(contexto, R.color.VerdeStd, Rec_Registro_Seleccion_Lote.this);
                ...
                if (decision.equals("true")) {
                    switch (Tarea)
                    {
                        case "Tabla":
                            ...
                            tabla.setDataAdapter(st = new SimpleTableDataAdapter(Rec_Registro_Seleccion_Lote.this, DATA_TO_SHOW));
