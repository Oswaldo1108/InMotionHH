package com.automatica.AXCMP.cIncidencia;
...
public class Incidencia extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btn_TomarFoto = (Button) findViewById(R.id.btn_EnviarWS);
        btn_Buscar = (Button) findViewById(R.id.btn_EnviarWS2);
                        ...
                        switch (Tarea)
                            {
                                ...
                                case "EnviarIncidencia":
                                    if(currentPhotoPath==null)
                                        {
                                            new popUpGenerico(Incidencia.this, getCurrentFocus(), "currentPhotoPath es nulo.", dao.iscEstado(), true, true);
                                            return;
                                        }
