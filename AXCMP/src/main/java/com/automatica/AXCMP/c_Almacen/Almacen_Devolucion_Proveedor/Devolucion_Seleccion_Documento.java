...
public class Devolucion_Seleccion_Documento extends AppCompatActivity
{
    //region variables
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.devolucion_activity_seleccion_documento);
        new cambiaColorStatusBar(contexto, R.color.doradoLetrastd, Devolucion_Seleccion_Documento.this);
    ...
    private void declaraVariables()
    {
        try {
            ...
            getSupportActionBar().setSubtitle(getString(R.string.dev_proveedor));
    ...
    private void ValidacionFinal()
    {
        ...
        //if(OrdenCompraSeleccionada)
        {
          ...
          //  b.putString("FechaCaducidad", "FechaCaducidad");
            Intent intent = new Intent(Devolucion_Seleccion_Documento.this, Devolucion_Seleccion_Tipo_Devolucion.class);
    ...
    class SegundoPlano extends AsyncTask<Void,Void,Void>
    {
        ...
        protected Void doInBackground(Void... voids)
        {
            try
            {
                ...
                {
                    case"Tabla":
                        sa.SOAPListarPartidasDevolucionProveedor(edtx_OrdenCompra.getText().toString(),contexto);
                ...
                if (decision.equals("true")) {
                    switch (Tarea) {
                        case "Tabla":
                            ...
                            tabla.setDataAdapter(st = new SimpleTableDataAdapter(Devolucion_Seleccion_Documento.this, DATA_TO_SHOW));
