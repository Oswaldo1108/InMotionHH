...
import com.automatica.AXCMP.c_Consultas.fragments.frgmnt_ConsultaBusquedaNumParte;
import com.automatica.AXCMP.c_Consultas.fragments.frgmnt_ConsultaEmpaque;
import com.automatica.AXCMP.c_Consultas.fragments.frgmnt_ConsultaPallet;
import com.automatica.AXCMP.c_Consultas.fragments.frgmnt_ConsultaPosicion;
import com.automatica.AXCMP.c_Consultas.fragments.frgmnt_ConsultaReferencia;


import org.ksoap2.serialization.SoapObject;
//frgmnt_ConsultasSelector.OnFragmentInteractionListener,
public class Almacen_Colocar_Prueba_FAB extends AppCompatActivity implements                                                                            frgmnt_ConsultaEmpaque.OnFragmentInteractionListener,
                                                                            frgmnt_ConsultaPallet.OnFragmentInteractionListener,
                                                                            frgmnt_ConsultaPosicion.OnFragmentInteractionListener,
                                                                            frgmnt_ConsultaReferencia.OnFragmentInteractionListener,
                                                                            frgmnt_ConsultaBusquedaNumParte.OnFragmentInteractionListener
...

{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.almacen_activity_colocar_prueba_fab);
        new cambiaColorStatusBar(contexto, R.color.doradoLetrastd, Almacen_Colocar_Prueba_FAB.this);
        declararVariables();
        agregaListeners();
    }
...
//        frgmnt_ConsultasSelector fcs = frgmnt_ConsultasSelector.newInstance(null,null);
//        fragmentTransaction.add(R.id.constraintLayout7, fcs);
        ...
        edtx_CodigoPallet.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    new esconderTeclado(Almacen_Colocar_Prueba_FAB.this);
                }
