...
public class Almacen_Envio_Maquila_Envio_Empaque extends AppCompatActivity
{
    //region variables
    ...
    EditText edtx_ConfirmaEmpaque;
    String Producto, Contenido, Lote, Caducidad, OrdenCompra,Cantidad;
    Handler h = new Handler();
    String ProductoConsultaPallet,CaducidadConsultaPallet,Empaques,ContenidoConsultaPAllet,LoteConsultaPallet,Estatus;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try
            ...
            setContentView(R.layout.recepcion_activity_envio_maquila__surtir__empaque_v2);
            declaraVariables();
            agregaListeners();
            SacaDatosIntent();
    ...
    private void declaraVariables()
    {
        ...
        new cambiaColorStatusBar(contexto, R.color.doradoLetrastd,
                Almacen_Envio_Maquila_Envio_Empaque.this);
        ...
        edtx_ConfirmaEmpaque= (EditText)findViewById(R.id.edtx_Cantidad);
                    ...
                    if(!edtx_ConfirmaEmpaque.getText().toString().equals(""))
                    {
                        if (edtx_ConfirmaEmpaque.getText().toString().equals(edtx_ConfirmaEmpaque.getText().toString()))
                        {
                          SegundoPlano sp = new SegundoPlano("ConfirmaPallet");
                            sp.execute();
                            new esconderTeclado(Almacen_Envio_Maquila_Envio_Empaque.this);
                        }
                        else
                        {
    ...
    private class SegundoPlano extends AsyncTask<Void,Void,Void>
    {
        ...
        protected Void doInBackground(Void... voids)
        {
            ...
            switch (tarea)
            {
                ...
                case "ConfirmaPallet" :
                    sa.SOAPEnviaEmpaqueMaquila(OrdenCompra, Partida, edtx_ConfirmaEmpaque.getText().toString(), "",contexto );
