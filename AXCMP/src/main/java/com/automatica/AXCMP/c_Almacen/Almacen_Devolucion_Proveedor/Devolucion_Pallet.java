...
public class Devolucion_Pallet extends AppCompatActivity
{
    //region variables
    ...
    EditText edtx_ConfirmaPallet,edtx_Comentario;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.devolucion_pallet);
        try
        {
            declaraVariables();
            agregaListeners();
    ...
    private void declaraVariables()
    {
        try
        {
            ...
            this.getSupportActionBar().setTitle(" "+getString(R.string.devolucion_proveedor_pallet));



            new cambiaColorStatusBar(contexto, R.color.doradoLetrastd,
                    Devolucion_Pallet.this);
            ...
            edtx_ConfirmaPallet = (EditText)findViewById(R.id.edtx_CodigoPallet);
    ...
    private void agregaListeners()
    {
        try
        {
            ...
            edtx_Comentario.setOnKeyListener(new View.OnKeyListener()
            {
                @Override
                public boolean onKey(View v, int keyCode, KeyEvent event)
                {
                    ...
                    if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                    {
                        h.post(new Runnable()
                            ...
                            new esconderTeclado(Devolucion_Pallet.this);
                        }
        ...
        protected Void doInBackground(Void... voids)
        {
            ...
            try
            {
                switch (tarea)
                {
                    ...
                    case "DevulvePallet" :
                        sa.SOAPDevolucionPalletProveedor(OrdenCompra,Partida,edtx_ConfirmaPallet.getText().toString(),"",contexto);
