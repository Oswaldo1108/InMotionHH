package com.automatica.AXCMP.c_Almacen.Envios_Maquila;
...
public class Almacen_Registro_Seleccion_Tipo_Envio extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        this.getSupportActionBar().setTitle("Tipo de envío");




        new cambiaColorStatusBar(contexto,R.color.doradoLetrastd, Almacen_Registro_Seleccion_Tipo_Envio.this);
       ...
       // String Transferencia = b.getString("Transferencia");
        ...
        ListaAlmacen.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                {
                    case 0:
                        intent = new Intent(Almacen_Registro_Seleccion_Tipo_Envio.this, Almacen_Envio_Maquila_Envio_Pallet.class);

                        break;
                    case 1:
                        intent = new Intent(Almacen_Registro_Seleccion_Tipo_Envio.this, Almacen_Envio_Maquila_Envio_Empaque.class);
                        break;
        ...
        adaptadorTablaMenuPrincipal adaptador = new adaptadorTablaMenuPrincipal(Almacen_Registro_Seleccion_Tipo_Envio.this, R.layout.menu_item, lista);
