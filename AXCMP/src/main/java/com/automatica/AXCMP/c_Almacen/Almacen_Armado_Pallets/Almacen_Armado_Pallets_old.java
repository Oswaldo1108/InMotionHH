    ...
    private void agregaListeners()
    {
        ...
        btn_CerrarTarima.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
             ...
             {
                 new popUpGenerico(contexto,vista ,getString(R.string.error_pallet_sin_empaques) , "false",true , true);
             }
            }
        });
        ...
        protected void onPostExecute(Void aVoid)
        {
            if (decision.equals("true"))
            {
                switch (tarea)
                {
                    ...
                    case "CerrarTarima":
                        new popUpGenerico(contexto, vista, "Tarima cerrada ["+mensaje+"] con exito.", decision, true, true);
                        break;
        ...
        try {
            ...
            if (tabla != null)
                for (int i = 0; i < tabla.getPropertyCount(); i++)
                {
                    ...
                    {
                        case "ConsultaOrdenProduccion":
                            EstatusOP = tabla1.getPrimitivePropertyAsString("Status");
