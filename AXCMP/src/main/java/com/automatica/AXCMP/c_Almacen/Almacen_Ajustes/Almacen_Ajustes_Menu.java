...
public class Almacen_Ajustes_Menu extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //toolbar.setSubtitle("  Ajustes de Inventario");
        ...
        constructorTablaMenuPrincipal Colocar = new constructorTablaMenuPrincipal(iconoAlmacen1,"Nuevo miaxc_consulta_pallet","Descripción Ajustes Positivos");
        ...
        constructorTablaMenuPrincipal Cuarentena = new constructorTablaMenuPrincipal(iconoAlmacen4,"Baja Pallet","Descripción Baja Pallet");
        ...
        ListaAlmacen.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                {
                    case 0:
                        intent = new Intent(Almacen_Ajustes_Menu.this, Almacen_Ajustes_AjustePallet.class);
                        break;
                    case 1:
                        intent = new Intent(Almacen_Ajustes_Menu.this, Almacen_Ajustes_NuevoEmpaque.class);
                        break;
                    case 2:
                        intent = new Intent(Almacen_Ajustes_Menu.this, Almacen_Ajustes_BajaEmpaque.class);
                        break;
                    case 3:
                        intent = new Intent(Almacen_Ajustes_Menu.this, Almacen_Ajustes_BajaPallet.class);
                        break;
                }
        ...
        adaptadorTablaMenuPrincipal adaptador = new adaptadorTablaMenuPrincipal(Almacen_Ajustes_Menu.this, R.layout.menu_item, lista);
