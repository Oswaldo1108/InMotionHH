...
public class Almacen_Cuarentena_Baja extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new cambiaColorStatusBar(contexto, R.color.doradoLetrastd, Almacen_Cuarentena_Baja.this);
    }
    @Override
    ...
    private void declararVariables()
    {
        ...
        this.getSupportActionBar().setTitle(getString(R.string.cuarentena_baja));
        ...
        edtx_CodigoPallet.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    new esconderTeclado(Almacen_Cuarentena_Baja.this);
                }
                return false;
            }
        });
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    if(!edtx_CodigoPallet.getText().toString().equals(""))
                    {
                        ...
                        {
                            SegundoPlano sp = new SegundoPlano("RegistrarBaja");
                            sp.execute();
            ...
            try {
                ...
                switch (tarea) {
                    ...
                    case "RegistrarBaja":
                        ...
                        sa.SOAPCuarentenaBajaPallet(edtx_ConfirmaPallet.getText().toString(), contexto);
                        decision = sa.getDecision();
                        mensaje = sa.getMensaje();
                ...
                if (decision.equals("true")) {
                    switch (tarea) {
                        case "ConsultaPallet":
                            ...
                            break;
                        case "RegistrarBaja":
                            new popUpGenerico(contexto, vista, getString(R.string.pallet_baja_cuarentena_exito), "Registrado", true, true);
                            borrarDatos();
                            break;
