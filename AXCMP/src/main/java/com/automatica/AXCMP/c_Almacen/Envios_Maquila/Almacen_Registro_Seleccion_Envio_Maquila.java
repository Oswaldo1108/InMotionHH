...
public class Almacen_Registro_Seleccion_Envio_Maquila extends AppCompatActivity
{
    //region variables
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new cambiaColorStatusBar(contexto, R.color.doradoLetrastd, Almacen_Registro_Seleccion_Envio_Maquila.this);
    ...
    private void ValidacionFinal()
    {
        ...
        //if(OrdenCompraSeleccionada)
        {
          ...
          //  b.putString("FechaCaducidad", "FechaCaducidad");
            Intent intent = new Intent(Almacen_Registro_Seleccion_Envio_Maquila.this, Almacen_Registro_Seleccion_Tipo_Envio.class);
            ...
            try
            {
                ...
                switch (Tarea)
                {
                    ...
                    //    sa.SOAPListarPartidasEnvioMaquila(edtx_OrdenCompra.getText().toString(),contexto);
                        ...
                        sa.SOAPConsultarPartidaEnvioMaquila(edtx_OrdenCompra.getText().toString(),null,contexto);
                        break;
                ...
                if (decision.equals("true")) {
                    switch (Tarea) {
                        case "Tabla":
                            ...
                            tabla.setDataAdapter(st = new SimpleTableDataAdapter(Almacen_Registro_Seleccion_Envio_Maquila.this, DATA_TO_SHOW));
