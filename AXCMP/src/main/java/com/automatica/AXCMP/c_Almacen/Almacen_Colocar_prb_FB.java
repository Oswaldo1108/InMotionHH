...
import com.automatica.AXCMP.Fragmentos.frgmnt_Ej_Consulta;
import com.automatica.AXCMP.Fragmentos.frgmnt_Menu_Principal;
import com.automatica.AXCMP.Fragmentos.frgmnt_taskbar_AXC;
...
import com.automatica.AXCMP.c_Carrito_Surtido.frgmnt_Imprime_Etiquetas;
...
public class Almacen_Colocar_prb_FB extends AppCompatActivity implements frgmnt_taskbar_AXC.OnFragmentInteractionListener,frgmnt_Menu_Principal.OnFragmentInteractionListener, frgmnt_Ej_Consulta.OnFragmentInteractionListener
{
    //region variables
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new cambiaColorStatusBar(contexto, R.color.camposAzul, Almacen_Colocar_prb_FB.this);
        declararVariables();
        agregaListeners();
...
//                .setCustomAnimations(R.anim.enter_bottom_to_top, R.anim.exit_top_to_bottom)
                .add(R.id.cl, frgmnt_taskbar_AXC.newInstance("",""), "frgtag_ImpEtiqueta")
                .commit();
...
//        toolbar.setLogo(R.mipmap.axc_logo_new_300x155);
        ...
        edtx_CodigoPallet.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    new esconderTeclado(Almacen_Colocar_prb_FB.this);
                }
    ...
    {
                getSupportFragmentManager().beginTransaction()
                        .setCustomAnimations(R.anim.enter_bottom_to_top, R.anim.exit_top_to_bottom,R.anim.enter_bottom_to_top, R.anim.exit_top_to_bottom)
                        .add(R.id.constraintLayout7, frgmnt_Menu_Principal.newInstance(null, null), "frgtag_MenuPrin").addToBackStack("frgtag_MenuPrin")
                        .commit();
        return false;
    }
