package com.automatica.AXCMP.MejorasAXC;
...
import com.automatica.AXCMP.frgmnt_Timeline_Pentagono;
...
public class REA extends AppCompatActivity implements frgmnt_Timeline_Pentagono.OnFragmentInteractionListener, Adaptador_RV_TimeLine.onClickRV

{
    ...
    private static final String frgtag_Timeline_Pentagono = "frgtag_Timeline_Pentagono";
    boolean recargar;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.pentagono_prb);
        new cambiaColorStatusBar(contexto, R.color.RojoStd, REA.this);
        declararVariables();
        agregaListeners();
    }
    ...
    private void declararVariables()
    {
        ...
        getSupportActionBar().setTitle("Pentágono");
...
//        txtv_Estatus = (TextView) findViewById(R.id.txtv_Estatus);
    ...
    protected void onResume()
    {
        getSupportFragmentManager().beginTransaction()
                ...
                .replace(R.id.constraintLayout, frgmnt_Timeline_Pentagono.newInstance(null, null),frgtag_Timeline_Pentagono)
                .commit();
