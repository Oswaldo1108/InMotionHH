...
public class Prueba_PENTAGONO extends AppCompatActivity implements frgmnt_Timeline_Pentagono.OnFragmentInteractionListener, Adaptador_RV_TimeLine.onClickRV

{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new cambiaColorStatusBar(contexto, R.color.RojoStd, Prueba_PENTAGONO.this);
        declararVariables();
        agregaListeners();
    }
