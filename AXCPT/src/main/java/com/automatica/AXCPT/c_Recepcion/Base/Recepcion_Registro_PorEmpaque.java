...
public class Recepcion_Registro_PorEmpaque extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try
        {
            ...
            new cambiaColorStatusBar(contexto, R.color.VerdeStd, Recepcion_Registro_PorEmpaque.this);
            SacaExtrasIntent();
            declararVariables();
            AgregaListeners();
...
//            TipoRecepcion = b.getString("Tipo");
    ...
    private class SegundoPlano extends AsyncTask<Void,Void,Void>
    {
        ...
        cAccesoADatos_Recepcion ca = new cAccesoADatos_Recepcion(Recepcion_Registro_PorEmpaque.this);
...
//            recargar=true;
                ...
                if(dao.iscEstado())
                {
                    ...
                    switch (tarea)
                    {
                        case "RegistrarEmpaqueNuevo":
                            ...
                            new esconderTeclado(Recepcion_Registro_PorEmpaque.this);
                            ...
                            if(dao.getcTablas() != null)
                                {
                                    ...
                                    spnr_Lotes.setAdapter(new CustomArrayAdapter(Recepcion_Registro_PorEmpaque.this,android.R.layout.simple_spinner_item, dao.getcTablasSorteadas("LoteAXC","CantidadRecibida","CantidadRegistrada","FechaCaducidad")));
    ...
    {
        Recepcion_Registro_PorEmpaque.this.finish();
        super.onBackPressed();
    }
}
