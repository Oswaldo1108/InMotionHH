...
public class Recepcion_Registro_Granel_NE_LoteModificable extends AppCompatActivity
{
        ...
        try
            {
                ...
                new cambiaColorStatusBar(contexto, R.color.VerdeStd, Recepcion_Registro_Granel_NE_LoteModificable.this);
                SacaExtrasIntent();
                declararVariables();
                AgregaListeners();
//                new SegundoPlano("ConsultaPallet").execute();
    ...
    private void declararVariables()
    {
        try {
            ...
            getSupportActionBar().setTitle(getString(R.string.recepcion_granel));
                                ...
                                if (edtx_CantidadPaquetes.getText().toString().equals(""))
                                    {
                                        ...
                                        new popUpGenerico(contexto, getCurrentFocus(),getString(R.string.error_ingrese_cantidad) +  "Cantidad Paquetes","Advertencia", true, true);
                                ...
                                if (edtx_CanXPaqt.getText().toString().equals(""))
                                    {
                                        ...
                                        new popUpGenerico(contexto, getCurrentFocus(),getString(R.string.error_ingrese_cantidad) + "Cantidad por Paquete","Advertencia", true, true);
...
//        });
    ...
    private class SegundoPlano extends AsyncTask<String,Void,Void>
    {
        ...
        cAccesoADatos_Recepcion ca = new cAccesoADatos_Recepcion(Recepcion_Registro_Granel_NE_LoteModificable.this);
                    ...
                    if(dao.iscEstado())
                        {
                            ...
                            switch (tarea)
                                {
                                    case "ListaMercados":
                                        spnr_Mercado.setAdapter(new CustomArrayAdapter(Recepcion_Registro_Granel_NE_LoteModificable.this, android.R.layout.simple_spinner_item,dao.getcTablasSorteadas("Mercado","DMercado")));
                                        break;
                                    ...
                                    case "RegistrarEmpaqueNuevoSA":
                                        ...
                                        new esconderTeclado(Recepcion_Registro_Granel_NE_LoteModificable.this);
...
//                                                new SegundoPlano("RegistraPalletNuevo").execute();
                                        ...
                                        if(dao.getcTablas() != null)
                                            {
                                                ...
                                                spnr_Lotes.setAdapter(new CustomArrayAdapter(Recepcion_Registro_Granel_NE_LoteModificable.this,android.R.layout.simple_spinner_item, dao.getcTablasSorteadas("LoteAXC","CantidadTotalPartida","CantidadRegistrada","CantidadTotalRegPartida")));
    ...
    {
        Recepcion_Registro_Granel_NE_LoteModificable.this.finish();
        super.onBackPressed();
    }
}
