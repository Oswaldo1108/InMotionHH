...
public class Recepcion_Registro__PorEmpaque_LoteModificable extends AppCompatActivity
{
    //region variables
    String TAG = "SoapResponse";
    EditText  edtx_EmpxPallet, edtx_Cantidad,edtx_CodigoEmpaque,edtx_LoteNuevo;
    String  Cantidad;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try
        {
            ...
            setContentView(R.layout.recepcion_activity_registro_oc_porempaque_lote_modificable);
            new cambiaColorStatusBar(contexto, R.color.VerdeStd, Recepcion_Registro__PorEmpaque_LoteModificable.this);
            SacaExtrasIntent();
            declararVariables();
            AgregaListeners();
        ...
        {
            e.printStackTrace();
            new popUpGenerico(contexto,null,e.getMessage()+" "+e.getCause() ,"false" ,true,true);
        }
    }
    @Override
    ...
    private void declararVariables()
    {
        try {
            ...
            spnr_Lotes = (Spinner) findViewById(R.id.vw_spinner).findViewById(R.id.spinner);
                ...
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    try
                    {
                        ...
                        if (edtx_CodigoEmpaque.getText().toString().equals(""))
                            {
                                new popUpGenerico(Recepcion_Registro__PorEmpaque_LoteModificable.this,edtx_CodigoEmpaque,"Código de empaque vacio",false,true,true);
                                return false;
                            }
        ...
        spnr_Lotes.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
            {
                try
                {
                    ...
                    //("LoteAXC","CantidadTotalPartida","CantidadRegistrada","CantidadTotalRegPartida")
                }catch (Exception e)
                {
                    e.printStackTrace();
                    new popUpGenerico(contexto, getCurrentFocus(), e.getMessage(), "false", true, true);
...
//            TipoRecepcion = b.getString("Tipo");
    ...
    private class SegundoPlano extends AsyncTask<Void,Void,Void>
    {
        ...
        cAccesoADatos_Recepcion ca = new cAccesoADatos_Recepcion(Recepcion_Registro__PorEmpaque_LoteModificable.this);
                ...
                switch (tarea)
                    ...
                    case "ConsultaPallet":
                        ...
                        case "RegistrarEmpaqueNuevoSA":
                            ...
                            if(spnr_Lotes.getAdapter() == null)
                            {
                                dao = ca.c_OCRegistrarEmpaqueCompra_Mercado_SA(OrdenCompra,
                                        PartidaERP,
                                        edtx_CodigoEmpaque.getText().toString(),
                                        "",
                                        edtx_Cantidad.getText().toString(),
                                        edtx_EmpxPallet.getText().toString(),mercado
                                );
                            }else{
                                dao = ca.c_OCRegistrarEmpaqueCompra_Mercado_SA(OrdenCompra,
                                        PartidaERP,
                    ...
                    case "RegistrarEmpaqueNuevo":
                        ...
                        if(spnr_Lotes.getAdapter() == null)
                            {
                                    dao = ca.c_OCRegistrarEmpaqueCompra_Mercado(OrdenCompra,
                                            PartidaERP,
                                            edtx_CodigoEmpaque.getText().toString(),
                                            "",
                                            edtx_Cantidad.getText().toString(),
                ...
                if(dao.iscEstado())
                {
                    ...
                    switch (tarea)
                    {
                        ...
                        case "RegistrarEmpaqueNuevo":
                            ...
                            new esconderTeclado(Recepcion_Registro__PorEmpaque_LoteModificable.this);
...
//                                new SegundoPlano("CerrarRecepcion").execute();
                            ...
                            if(dao.getcTablas() != null)
                                {
                                    ...
                                    spnr_Lotes.setAdapter(new CustomArrayAdapter(Recepcion_Registro__PorEmpaque_LoteModificable.this,android.R.layout.simple_spinner_item, dao.getcTablasSorteadas("LoteAXC","CantidadTotalPartida","CantidadRegistrada","CantidadTotalRegPartida")));
                        ...
                        break;
                        case "ListaMercados":
                            spnr_Mercado.setAdapter(new CustomArrayAdapter(Recepcion_Registro__PorEmpaque_LoteModificable.this, android.R.layout.simple_spinner_item,dao.getcTablasSorteadas("Mercado","DMercado")));
                            break;
    ...
    {
        Recepcion_Registro__PorEmpaque_LoteModificable.this.finish();
        super.onBackPressed();
    }
}
