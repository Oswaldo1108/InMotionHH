...
public class Recepcion_Registro_PrimerasYUltimas extends AppCompatActivity
{
    ...
    String Pallet,Producto, Cantidad,Lote,CodigoPallet,EmpaquesRegistrados;
    String TAG = "SoapResponse";
    FrameLayout progressBarHolder;
    AlphaAnimation inAnimation;
    AlphaAnimation outAnimation;
    TextView txtv_EmpaquesRegistrados, txtv_OrdenCompra,txtv_Partida,txtv_UM,txtv_CantidadOriginal,txtv_CantidadRegistrada,txtv_Producto,txtv_CantidadLote,txtv_CantRegLote;
    Bundle b;
    View vista;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try {
            ...
            new cambiaColorStatusBar(contexto, R.color.VerdeStd, Recepcion_Registro_PrimerasYUltimas.this);
            SacaExtrasIntent();
            declararVariables();
            AgregaListeners();
    ...
    private void AgregaListeners()
    {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    try
                    {
                        ...
                        new esconderTeclado(Recepcion_Registro_PrimerasYUltimas.this);
        ...
        spnr_OrdenesCompra.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            {
                try {
                    txtv_CantidadLote.setText( ((Constructor_Dato)spnr_OrdenesCompra.getSelectedItem()).getTag1());
                    txtv_CantRegLote.setText( ((Constructor_Dato)spnr_OrdenesCompra.getSelectedItem()).getTag2());
                    txtv_Caducidad.setText( ((Constructor_Dato)spnr_OrdenesCompra.getSelectedItem()).getTag3());
                }catch (Exception e)
                    {
                        e.printStackTrace();
                        new popUpGenerico(contexto, getCurrentFocus(), e.getMessage(), "false", true, true);
    ...
    private class SegundoPlano extends AsyncTask<Void,Void,Void>
    {
        ...
        cAccesoADatos_Recepcion ca  = new cAccesoADatos_Recepcion(Recepcion_Registro_PrimerasYUltimas.this);
        String tarea;
        View LastView;
            ...
            try
            {
                ...
                switch (tarea)
                {
                    ...
                    case "RegistraPalletNuevo":
                        ...
                        dao= ca.c_CierraPalletCompra(CodigoPallet);
                ...
                if(dao.iscEstado())
                {
                    switch (tarea)
                    {
                        case "RegistrarEmpaqueNuevo":
                            ...
                            CantidadEmpaques = dao.getSoapObject_parced().getPrimitivePropertyAsString("CantEmpaques");
                            ...
                            {
                                new popUpGenerico(contexto, getCurrentFocus(), getString(R.string.orden_compra_completada), String.valueOf(dao.iscEstado()), true, true);
                            ...
                            {
                                new popUpGenerico(contexto, getCurrentFocus(), getString(R.string.orden_compra_partida_completa), String.valueOf(dao.iscEstado()), true, true);
                        ...
                        case "RegistraPalletNuevo":
                            new popUpGenerico(contexto, getCurrentFocus(),"Pallet ["+dao.getcMensaje()+"] Cerrado con éxito",String.valueOf(dao.iscEstado()), true, true);
                            new SegundoPlano("ListarOrdenesCompra").execute();
                            reiniciarVariables();
                            break;
                        case "ListarOrdenesCompra":
                            ...
                            if(dao.getcTablas() != null)
                                {
                                    ...
                                    spnr_OrdenesCompra.setAdapter(new CustomArrayAdapter(Recepcion_Registro_PrimerasYUltimas.this,android.R.layout.simple_spinner_item, dao.getcTablasSorteadas("LoteAXC","CantidadRecibida","CantidadRegistrada","FechaCaducidad")));
