...
public class SurtidoProdEmpaque extends AppCompatActivity implements TableViewDataConfigurator.TableClickInterface, frgmnt_taskbar_AXC.interfazTaskbar {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try {
            ...
            new cambiaColorStatusBar(contexto, R.color.MoradoStd, SurtidoProdEmpaque.this);
            SacaExtrasIntent();
            declararVariables();
            agregaListeners();
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    if(!edtx_ConfirmarEmpaque.getText().toString().equals(""))
                    {
                        ...
                        new SurtidoProdEmpaque.SegundoPlano("RegistrarEmpaque").execute();
                    }else
                    {
                        handler.post(new Runnable()
                        {
                    ...
                    new esconderTeclado(SurtidoProdEmpaque.this);
                    return true;
                }
                return false;
            }
    ...
    public void BotonDerecha()
    {
        ...
        new CreaDialogos(getString(R.string.pregunta_cierre_pallet),
                new DialogInterface.OnClickListener()
                {
                    ...
                    {
                        new SurtidoProdEmpaque.SegundoPlano("CerrarTarima").execute();
                    }
                },null,contexto);
    }
    ...
    private class SegundoPlano extends AsyncTask<String,Void,Void>
    {
        ...
        cAccesoADatos_RegistroPT cadEmb = new cAccesoADatos_RegistroPT(SurtidoProdEmpaque.this);
        ...
        protected Void doInBackground(String... params)
        {
            try
            {
                ...
                switch (tarea)
                {
                    ...
                    case "SugiereEmpaque":
                        dao = cadEmb.cad_ConsultaEmpaqueProdSugerido(Pedido,Partida);
                        break;

                    case "ConsultaEmpaque":
                        dao = cadEmb.cad_ConsultaEmpaqueSurtidoProd(Pedido,Partida,edtx_Empaque.getText().toString());
                        break;

                    case "RegistrarEmpaque":

                        dao = cadEmb.cad_RegistroEmpaqueSurtidoProd(Pedido,Partida,edtx_Empaque.getText().toString(),tmpCarrito);
                    ...
                    case "ConsultaPalletAbierto":
                        ...
                        dao = cadEmb.cad_ConsultaTarimaConsolidadaProd(Pedido,tmpCarrito);
                    ...
                    switch (tarea)
                    {
                        case"ConsultaPedidoSurtido":
                            if(dao.getcTablas() != null)
                            {
                                ...
                                sp_partidas.setAdapter(c = new CustomArrayAdapter(SurtidoProdEmpaque.this,
                        ...
                        case "ConsultaPedidoDet":
                            ...
                            new SurtidoProdEmpaque.SegundoPlano("SugiereEmpaque").execute();
                            break;
                        ...
                        case "SugiereEmpaque":
                            ...
                            new SurtidoProdEmpaque.SegundoPlano("ConsultaPalletAbierto").execute();
                            ...
                            if(dao.getcTablaUnica()!=null)
                            {
                                if(ConfigTabla == null)
                                {
                                    ConfigTabla =  new TableViewDataConfigurator(2,"Listo",
                                            "En proceso","-",tabla_Salidas, dao, SurtidoProdEmpaque.this);
                                }else
                                {
...
//                                        new SegundoPlano("PalletsArmadoPedido").execute();
                        ...
                        case "RegistrarEmpaque":
                            ...
                            new SurtidoProdEmpaque.SegundoPlano("ConsultaPedidoDet").execute(((Constructor_Dato) sp_partidas.getSelectedItem()).getDato());
