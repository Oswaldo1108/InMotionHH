...
import com.automatica.AXCPT.databinding.ActivityAlmacenArmadoPalletsConfBinding;
...
public class Almacen_Armado_Pallets_Conf extends AppCompatActivity implements TableViewDataConfigurator.TableClickInterface, frgmnt_taskbar_AXC.interfazTaskbar {
    ...
    ActivityAlmacenArmadoPalletsConfBinding binding;
    private static final String frgmnt_tag = "tag";
    private ProgressBarHelper p;
    popUpGenerico pop = new popUpGenerico(Almacen_Armado_Pallets_Conf.this);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityAlmacenArmadoPalletsConfBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN);
        new cambiaColorStatusBar(contexto, R.color.VerdeStd, Almacen_Armado_Pallets_Conf.this);
    ...
    protected void onResume() {
        ...
        new Almacen_Armado_Pallets_Conf.SegundoPlano("ConsultaMaquinas").execute();
        ...
        if (p.ispBarActiva())
        {
            ...
            if (id == R.id.recargar) {
                ...
                if (!binding.edtxOrdenProduccion.getText().toString().equals(""))
                {
                    ...
                    new Almacen_Armado_Pallets_Conf.SegundoPlano("ConsultaOrdenProduccion").execute();
                    new Almacen_Armado_Pallets_Conf.SegundoPlano("ConsultaMaquina").execute();
                    new Almacen_Armado_Pallets_Conf.SegundoPlano("ConsultarTarima").execute();
                }
            }
                        ...
                        if(!(arrayDatosTabla.length<=0))
                        {
                            new CreaDialogos(getString(R.string.pregunta_cancelar_pallet), new DialogInterface.OnClickListener()
                            {
                                public void onClick(DialogInterface dialog, int id) {
                                    ...
                                    new Almacen_Armado_Pallets_Conf.SegundoPlano("CancelarTarima").execute();
                                    new esconderTeclado(Almacen_Armado_Pallets_Conf.this);
                                }
                            },null,contexto);
                        }
                        else
    ...
    private class SegundoPlano extends AsyncTask<Void,Void,Void>
    {
        ...
        cAccesoADatos_RegistroPT cad = new cAccesoADatos_RegistroPT(Almacen_Armado_Pallets_Conf.this);
        cAccesoADatos_Consultas consAd = new cAccesoADatos_Consultas(Almacen_Armado_Pallets_Conf.this);
            ...
            try
            {
                switch (tarea)
                {
                    ...
                    case "RegistrarEmpaque":
                        dao = cad.c_RegistraEmpaqueEnPallet(binding.edtxEmpaque.getText().toString(), binding.edtxOrdenProduccion.getText().toString(),((Constructor_Dato)spnr_Maquinas.getSelectedItem()).getDato(),binding.edtxCantidad.getText().toString(), binding.edtxNumSerie.getText().toString());
                        break;
                ...
                if (dao.iscEstado())
                {
                    ...
                    switch (tarea)
                    {
                        ...
                        case "ConsultaMaquinas":
                            ...
                            spnr_Maquinas.setAdapter(new CustomArrayAdapter(Almacen_Armado_Pallets_Conf.this,android.R.layout.simple_spinner_item, dao.getcTablasSorteadas("DLinea","Linea")));
                        ...
                        case "ConsultarTarima":
                            if (ConfigTabla_Totales == null) {
                                ...
                                ConfigTabla_Totales = new TableViewDataConfigurator(tabla, dao,Almacen_Armado_Pallets_Conf.this);
                            } else{
                            ...
                            if (arrayDatosTabla != null)
                            {
                                ...
                                if(!dao.getcEncabezado()[0].contains("Pallet"))
                                {
                                    ...
                                    tabla.setHeaderAdapter(sthd = new SimpleTableHeaderAdapter(Almacen_Armado_Pallets_Conf.this, dao.getcEncabezado()));
                                    tabla.setDataAdapter(st = new SimpleTableDataAdapter(Almacen_Armado_Pallets_Conf.this, arrayDatosTabla));
                                    st.setTextColor(getResources().getColor(R.color.blancoLetraStd));
        ...
        binding.edtxEmpaque.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    {
                          new Almacen_Armado_Pallets_Conf.SegundoPlano("RegistrarEmpaque").execute();
                          new Almacen_Armado_Pallets_Conf.SegundoPlano("ConsultaOrdenProduccion").execute();
                          new Almacen_Armado_Pallets_Conf.SegundoPlano("ConsultarTarima").execute();
                          binding.edtxNumSerie.requestFocus();
                    }else
                    ...
                    if(!(arrayDatosTabla.length<=0))
                    {
                        new CreaDialogos(getString(R.string.pregunta_cierre_pallet), new DialogInterface.OnClickListener()
                        {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                new Almacen_Armado_Pallets_Conf.SegundoPlano("CerrarTarima").execute();
                                new esconderTeclado(Almacen_Armado_Pallets_Conf.this);
                            }
                        },null,contexto);
                    }
