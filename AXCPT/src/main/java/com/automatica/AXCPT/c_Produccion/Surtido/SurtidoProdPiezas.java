...
import com.automatica.AXCPT.databinding.ActivitySurtidoProdPiezasBinding;
...
public class SurtidoProdPiezas extends AppCompatActivity implements TableViewDataConfigurator.TableClickInterface, frgmnt_taskbar_AXC.interfazTaskbar {
    ...
    private String strUPC,strSKU,strTipo, UM;
    //endregion

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_surtido_prod_piezas);
        new cambiaColorStatusBar(contexto, R.color.MoradoStd, SurtidoProdPiezas.this);
        SacaExtrasIntent();
        declararVariables();
        agregaListeners();
...
//        });
        ...
        edtx_ConfirmarEmpaque.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    new esconderTeclado(SurtidoProdPiezas.this);
                    return true;
                }
                return false;
            }
      ...
      switch_sku.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
      {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
            {
                    ...
                    }else
                    {
                        ...
                        edtx_ConfirmarEmpaque.setInputType(InputType.TYPE_NUMBER_FLAG_DECIMAL);
                    }
            }
        });
    ...
    private class SegundoPlano extends AsyncTask<String,Void,Void>
    {
        ...
        cAccesoADatos_RegistroPT cadEmb = new cAccesoADatos_RegistroPT(SurtidoProdPiezas.this);
        ...
        protected Void doInBackground(String... params)
        {
            try
            {
                ...
                switch (tarea)
                {
                    ...
                    case "SugiereEmpaque":
                        dao = cadEmb.cad_ConsultaContenedorSugeridoProd(Pedido,Partida);
                        break;

                    case "ConsultaEmpaque":
                        dao = cadEmb.c_ConsultaContenedorSurtidoProd(Pedido,Partida,edtx_Empaque.getText().toString());
                        break;

                    case "RegistrarCant":
                        dao = cadEmb.c_OSSurtirPiezasProd(Pedido,Partida,edtx_Empaque.getText().toString(),edtx_ConfirmarEmpaque.getText().toString(),txtv_PalletAbierto.getText().toString());
                        break;

                    case "RegistrarSKU":
                        dao = cadEmb.c_OSSurtirPiezasSKUProd(Pedido,Partida,edtx_Empaque.getText().toString(),edtx_ConfirmarEmpaque.getText().toString(),txtv_PalletAbierto.getText().toString());
                        break;

                    case "CancelarReg":
                        dao = cadEmb.c_OSCancelarSurtPiezasProd(Pedido,Partida,edtx_Empaque.getText().toString(),String.valueOf(intPiezas),txtv_PalletAbierto.getText().toString());
                        break;
                ...
                if (dao.iscEstado())
                {
                    switch (tarea)
                    {
                        case"ConsultaPedidoSurtido":
                            ...
                            {
                                sp_partidas.setAdapter(new CustomArrayAdapter(SurtidoProdPiezas.this,
                            ...
                            break;
                        case "ConsultaPedidoDet":
                            UM = dao.getSoapObject_parced().getPrimitivePropertyAsString("UM");
                            txtv_CantReg.setText(dao.getSoapObject_parced().getPrimitivePropertyAsString("CantidadSurtida")+"-"+UM);
                            txtv_CantPend.setText(dao.getSoapObject_parced().getPrimitivePropertyAsString("CantidadPendiente")+"-"+UM);
                        ...
                        case "ConsultaPalletAbierto":
                            if(dao.getcTablaUnica()!=null)
                            {
                                if(ConfigTabla == null)
                                {
                                    ConfigTabla =  new TableViewDataConfigurator(tabla_Salidas, dao, SurtidoProdPiezas.this);
