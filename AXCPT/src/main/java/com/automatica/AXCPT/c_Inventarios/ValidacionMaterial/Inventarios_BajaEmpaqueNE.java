...
public class Inventarios_BajaEmpaqueNE extends AppCompatActivity {
    Bundle b;
    ...
    TableView tabla;
    Context contexto = Inventarios_BajaEmpaqueNE.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inventarios__baja_empaque_n_e);
        try {
            SacaExtrasIntent();
            ...
            try {
                switch (tarea) {
                    case "llenarTabla":
                        ...
                        break;
                    case "Baja":
                        dao = ca.c_BajaEmpaquesInventario_NE(
                                IdInventario,
                                txtv_Pallet.getText().toString(),
                                Producto,
                                Lote, edtx_CantidadEmpaques.getText().toString());
                        break;
                    default:
