...
public class PopUpMenuProduccion {
    View v;
    Context contexto;
    ContextMenuListener listener;

    public PopUpMenuProduccion() {
    }

    public PopUpMenuProduccion(View v, Context contexto, int MenuResource) {
        this.v = v;
...
//        mypopupmenu.getMenu().getItem(0).setIcon(getResources().getDrawable(R.mipmap.ic_launcher));
    ...
    public PopUpMenuProduccion(View v, Context contexto, int MenuResource, boolean False) {
        this.v = v;
        this.contexto=contexto;
        //Inicializacion();
        Context wrapper = new ContextThemeWrapper(contexto, R.style.popupMenuStyle);
...
//        mypopupmenu.getMenu().getItem(0).setIcon(getResources().getDrawable(R.mipmap.ic_launcher));
    ...
    public PopUpMenuProduccion newInstance(View v, Context contexto, int MenuResource, ContextMenuListener listener){
        PopUpMenuProduccion menu = new PopUpMenuProduccion(v,contexto,MenuResource,false);
