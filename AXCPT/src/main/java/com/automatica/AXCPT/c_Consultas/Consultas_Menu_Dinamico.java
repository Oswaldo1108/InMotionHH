...
public class Consultas_Menu_Dinamico extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try {
            ...
            actionList.add(new Intent(Consultas_Menu_Dinamico.this, consultas_ConsultaPallet.class));
            ...
            constructorTablaMenuPrincipal Empaque = new constructorTablaMenuPrincipal(iconoAlmacen3, "Paquete", "Descripción Empaque");
            ...
            for (int i = 0; i < SeparadoApertura[0].length(); i++) //La posicion dos es de donde se sacan los permisos de pantallas
            {
