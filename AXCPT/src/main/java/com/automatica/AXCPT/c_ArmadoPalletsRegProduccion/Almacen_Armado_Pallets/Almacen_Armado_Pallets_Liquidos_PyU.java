...
public class Almacen_Armado_Pallets_Liquidos_PyU extends AppCompatActivity implements frgmnt_Cierre_Orden.OnFragmentInteractionListener
{
    //region variables
    Spinner spnr_Maquinas;
    String str_Maquina = "@";
    Toolbar toolbar;
    EditText edtx_Empaque,edtx_UltEmpaque, edtx_OrdenProduccion;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.almacen_armado_pallet_liquidos_pyu);

        new cambiaColorStatusBar(contexto, R.color.VerdeStd, Almacen_Armado_Pallets_Liquidos_PyU.this);
    ...
    private void declararVariables()
    {
        ...
        getSupportActionBar().setSubtitle("Prim. y Ult.");

        progressBarHolder = (FrameLayout) findViewById(R.id.progressBarHolder);


        edtx_Empaque = (EditText) findViewById(R.id.edtx_Empaque);
        edtx_UltEmpaque = (EditText)  findViewById(R.id.edtx_Empaque3);
...
//        tabla.setHeaderAdapter(new SimpleTableHeaderAdapter(contexto,HEADER));
        ...
        edtx_OrdenProduccion.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    new esconderTeclado(Almacen_Armado_Pallets_Liquidos_PyU.this);
                    return true;
                }
                return false;
            }
    ...
    edtx_Empaque.setOnKeyListener(new View.OnKeyListener()
    {
            ...
            if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    handler.postDelayed(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            edtx_UltEmpaque.requestFocus();
                            edtx_UltEmpaque.setText("");
        ...
        edtx_UltEmpaque.setOnKeyListener(new View.OnKeyListener()
        {
            @Override
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    if(!edtx_UltEmpaque.getText().toString().equals(""))
                    {
...
//                                sp.execute();
    ...
    private class SegundoPlano extends AsyncTask<Void,Void,Void>
    {
        ...
        cAccesoADatos_RegistroPT cad = new cAccesoADatos_RegistroPT(Almacen_Armado_Pallets_Liquidos_PyU.this);
        cAccesoADatos_Consultas consAd = new cAccesoADatos_Consultas(Almacen_Armado_Pallets_Liquidos_PyU.this);
                    ...
                    switch (tarea)
                        {
                            ...
                            case "RegistrarEmpaque":
                                ...
                                dao =   cad.c_RegistraEmpaqueEnPalletPrimeraYUltima(edtx_Empaque.getText().toString(),edtx_UltEmpaque.getText().toString(),edtx_OrdenProduccion.getText().toString(),((Constructor_Dato)spnr_Maquinas.getSelectedItem()).getDato(),"1");
                                break;
                            case "RegistraCaducidad":
                                dao =   cad.c_RegistraFechaCadOrdenProd(edtx_OrdenProduccion.getText().toString(), "");
                                break;
                            ...
                            switch (tarea)
                                {
                                    ...
                                    case "ConsultaMaquinas":
                                        ...
                                        spnr_Maquinas.setAdapter(new CustomArrayAdapter(Almacen_Armado_Pallets_Liquidos_PyU.this,android.R.layout.simple_spinner_item, dao.getcTablasSorteadas("DLinea","Linea")));
                                                ...
                                                if(!dao.getcEncabezado()[0].contains("Pallet"))
                                                    {
                                                        ...
                                                        tabla.setHeaderAdapter(sthd = new SimpleTableHeaderAdapter(Almacen_Armado_Pallets_Liquidos_PyU.this, dao.getcEncabezado()));
                                                        tabla.setDataAdapter(st = new SimpleTableDataAdapter(Almacen_Armado_Pallets_Liquidos_PyU.this, arrayDatosTabla));
                                                        st.setTextColor(getResources().getColor(R.color.blancoLetraStd));
                                                        sthd.setTextColor(getResources().getColor(R.color.blancoLetraStd));
    ...
    public void onBackPressed()
    {
        ...
        Intent intent = new Intent(Almacen_Armado_Pallets_Liquidos_PyU.this, Inicio_Menu_Dinamico.class);
