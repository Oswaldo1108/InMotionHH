...
public class Recepcion_Menu_Tipo_Recepcion_Tipo_Registro_Polvos extends AppCompatActivity
{
    ListView listaMenu;
    View vista;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        new cambiaColorStatusBar(contexto,R.color.VerdeStd, Recepcion_Menu_Tipo_Recepcion_Tipo_Registro_Polvos.this);
        ...
        listaMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                switch (position)
                {
                    ...
                    case 0:
                          intent = new Intent(Recepcion_Menu_Tipo_Recepcion_Tipo_Registro_Polvos.this, Almacen_Armado_Pallets_Polvos.class);
                          break;
                    case 1:
                        intent = new Intent(Recepcion_Menu_Tipo_Recepcion_Tipo_Registro_Polvos.this, Almacen_Armado_Pallets_Polvos_Primera_Y_Ultima.class);
                        break;
                }
        ...
        adaptadorTablaMenuPrincipal adaptador = new adaptadorTablaMenuPrincipal(Recepcion_Menu_Tipo_Recepcion_Tipo_Registro_Polvos.this, R.layout.menu_item, lista);
