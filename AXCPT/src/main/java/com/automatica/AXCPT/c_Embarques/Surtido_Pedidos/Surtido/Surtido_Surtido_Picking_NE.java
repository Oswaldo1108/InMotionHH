...
public class Surtido_Surtido_Picking_NE extends AppCompatActivity implements TableViewDataConfigurator.TableClickInterface
{
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.surtido_surtido_picking_ne);
        new cambiaColorStatusBar(contexto, R.color.MoradoStd, Surtido_Surtido_Picking_NE.this);
        SacaExtrasIntent();
        declararVariables();
        agregaListeners();
    ...
    private void declararVariables()
    {
        try {
            ...
            getSupportActionBar().setSubtitle("Posición Picking");
                ...
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                    {
                        if(!edtx_ConfirmarEmpaque.getText().toString().equals(""))
                            {
                                ...
                                new SegundoPlano("RegistrarSurtido").execute();
                            }else
                            {
                                handler.post(new Runnable()
                                {
                        ...
                        new esconderTeclado(Surtido_Surtido_Picking_NE.this);
                        return true;
                    }
                return false;
            }
                ...
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                    {
                        if(!edtx_Empaque.getText().toString().equals(""))
                            {
                                new SegundoPlano("ConsultaPiso").execute();
                            }else
                            {
...
//                    }
    ...
    private class SegundoPlano extends AsyncTask<Void,Void,Void>
    {
        ...
        cAccesoADatos_Embarques cadEmb = new cAccesoADatos_Embarques(Surtido_Surtido_Picking_NE.this);
                    ...
                    if (dao.iscEstado())
                            ...
                            switch (tarea)
                                {
                                    ...
                                    case "ConsultaPedidoDet":
                                        ...
                                        new SegundoPlano("SugierePiso").execute();
                                        break;
                                    ...
                                    case "ConsultaPalletAbierto":
                                        ...
                                        new TableViewDataConfigurator(tabla_Salidas, dao,Surtido_Surtido_Picking_NE.this);
                    ...
                    else
                        {
                            ...
                            if(dao.getcMensaje().contains("SURTIDA"))
                                {
                                    new popUpGenerico(contexto, getCurrentFocus(), "Partida surtida con éxíto.", true, true, true);
                                }
                            else
                                {
