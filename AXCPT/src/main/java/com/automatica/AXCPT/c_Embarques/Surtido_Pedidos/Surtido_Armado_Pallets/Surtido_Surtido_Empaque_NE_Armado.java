...
public class Surtido_Surtido_Empaque_NE_Armado extends AppCompatActivity  implements TableViewDataConfigurator.TableClickInterface, frgmnt_taskbar_AXC.interfazTaskbar
{
    //region variables
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.surtido_surtido_empaque_ne_armado);
        new cambiaColorStatusBar(contexto, R.color.MoradoStd, Surtido_Surtido_Empaque_NE_Armado.this);
        SacaExtrasIntent();
        declararVariables();
        agregaListeners();
...
//                        }
                    ...
                    new esconderTeclado(Surtido_Surtido_Empaque_NE_Armado.this);
                    return true;
                }
                return false;
            }
    ...
    private class SegundoPlano extends AsyncTask<String,Void,Void>
    {
        ...
        cAccesoADatos_Embarques cadEmb = new cAccesoADatos_Embarques(Surtido_Surtido_Empaque_NE_Armado.this);
        ...
        protected Void doInBackground(String... params)
        {
            try
            {
                switch (tarea)
                {
                    ...
                    case "RegistrarEmpaque":
                        dao = cadEmb.cad_RegistroEmpaqueSurtido_NE(Pedido,Partida,edtx_Empaque.getText().toString(),edtx_ConfirmarEmpaque.getText().toString(),txtv_PalletAbierto.getText().toString());
                        break;
                ...
                if (dao.iscEstado())
                {
                    switch (tarea)
                    {
                        case"ConsultaPedidoSurtido":
                            ...
                            {
                                sp_partidas.setAdapter(new CustomArrayAdapter(Surtido_Surtido_Empaque_NE_Armado.this,
                            ...
                            if(dao.getcTablaUnica()!=null)
                            {
                                if(ConfigTabla == null)
                                {
                                    ConfigTabla =  new TableViewDataConfigurator(2,"Listo",
                                            "En proceso","-",tabla_Salidas, dao, Surtido_Surtido_Empaque_NE_Armado.this);
                                }else
                                {
