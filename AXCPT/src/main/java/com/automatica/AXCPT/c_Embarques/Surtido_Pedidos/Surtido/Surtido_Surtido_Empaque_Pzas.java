...
public class Surtido_Surtido_Empaque_Pzas extends AppCompatActivity implements TableViewDataConfigurator.TableClickInterface
{
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new cambiaColorStatusBar(contexto, R.color.MoradoStd, Surtido_Surtido_Empaque_Pzas.this);
        SacaExtrasIntent();
        declararVariables();
        agregaListeners();
        ...
        edtx_ConfirmarEmpaque.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    new esconderTeclado(Surtido_Surtido_Empaque_Pzas.this);
                    return true;
                }
                return false;
            }
...
//                    }
    ...
    private class SegundoPlano extends AsyncTask<Void,Void,Void>
    {
        ...
        cAccesoADatos_Embarques cadEmb = new cAccesoADatos_Embarques(Surtido_Surtido_Empaque_Pzas.this);
                ...
                if (dao.iscEstado())
                {
                    switch (tarea)
                    {
                        ...
                        case "ConsultaPalletAbierto":
                            ...
                            new TableViewDataConfigurator(tabla_Salidas, dao, Surtido_Surtido_Empaque_Pzas.this);
