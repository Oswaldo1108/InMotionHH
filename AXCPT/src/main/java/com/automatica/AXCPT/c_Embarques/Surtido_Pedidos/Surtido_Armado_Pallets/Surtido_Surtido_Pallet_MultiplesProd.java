...
public class Surtido_Surtido_Pallet_MultiplesProd extends AppCompatActivity   implements TableViewDataConfigurator.TableClickInterface, frgmnt_taskbar_AXC.interfazTaskbar
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try
        {
            ...
            setContentView(R.layout.activity_surtido_pallet_mult_prod);
                ...
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                    {
                        ...
                        new esconderTeclado(Surtido_Surtido_Pallet_MultiplesProd.this);
                        return true;
                    }
                return false;
            }
    ...
    private class SegundoPlano extends AsyncTask<String,Void,Void>
    {
        ...
        cAccesoADatos_Embarques cadEmb = new cAccesoADatos_Embarques(Surtido_Surtido_Pallet_MultiplesProd.this);
                    ...
                    switch (tarea)
                        {
                            ...
                            case "RegistrarPallet":
                                ...
                                break;
                            case "RegistrarPalletMultPart":
                                dao = cadEmb.cad_RegistroPalletSurtidoMultPart(Pedido,edtx_ConfirmarPallet.getText().toString());
                                break;
                            default:
                            ...
                            switch (tarea)
                                {
                                    case"ConsultaPedidoSurtido":
                                        ...
                                        {
                                            sp_partidas.setAdapter(new CustomArrayAdapter(Surtido_Surtido_Pallet_MultiplesProd.this,
                                    ...
                                    case "ConsultaPallet":
                                        if(dao.getcTablaUnica()!=null)
                                        {
                                            if(ConfigTabla == null)
                                            {
                                                ConfigTabla =  new TableViewDataConfigurator(tabla, dao, Surtido_Surtido_Pallet_MultiplesProd.this);
                                            }else
                                            {
