...
public class fragmento_validacion_pallets extends Fragment
{
    ...
    public fragmento_validacion_pallets()
    {
        // Required empty public constructor
    }

    public static fragmento_validacion_pallets newInstance(String param1, String param2)
    {
        fragmento_validacion_pallets fragment = new fragmento_validacion_pallets();
    ...
    public void onAttach(Context context)
    {
        ...
        if (context instanceof fragmento_validacion_pallets.fragValInterface)
        {
