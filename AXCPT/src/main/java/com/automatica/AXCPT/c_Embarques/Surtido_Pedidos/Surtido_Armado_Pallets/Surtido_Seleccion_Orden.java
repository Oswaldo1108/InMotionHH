...
import com.automatica.axc_lib.AccesoDatos.MetodosConexion.conexionWS;
...
public class Surtido_Seleccion_Orden extends AppCompatActivity implements frgmnt_taskbar_AXC.interfazTaskbar{

    private Toolbar toolbar;
    private ActivityHelpers activityHelpers;
    private ProgressBarHelper p;
    private ActivityEmbarquesSeleccionOrdenBinding binding;
    private Context contexto = Surtido_Seleccion_Orden.this;
    ...
    private void InicializarVariables(){
        ...
        activityHelpers.AgregarMenus(Surtido_Seleccion_Orden.this,R.id.Pantalla_principal,true);
        toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Surtido");
        getSupportActionBar().setSubtitle("Selección Documento");
        tabla = binding.customtableview.tableViewOC;


        tableViewDataConfigurator =  TableViewDataConfigurator.newInstance(tabla, null, Surtido_Seleccion_Orden.this, new TableViewDataConfigurator.TableClickInterface() {
            @Override
...
//        }
      ...
      if(tableViewDataConfigurator.renglonEstaSelec())
      {
        ...
        startActivity(new Intent(contexto, Surtido_Seleccion_Partida.class).putExtras(b));
            ...
            try {
                switch (Tarea) {
                    case "ConsultaOrdenes":
                            dao = ca.c_ConsultaOrdenSurtido("@","LIBERADA TOTAL");
                        break;
                    default:
