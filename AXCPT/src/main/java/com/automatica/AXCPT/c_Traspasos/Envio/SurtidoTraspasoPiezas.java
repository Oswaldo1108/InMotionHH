...
public class SurtidoTraspasoPiezas extends AppCompatActivity implements TableViewDataConfigurator.TableClickInterface, frgmnt_taskbar_AXC.interfazTaskbar {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new cambiaColorStatusBar(contexto, R.color.MoradoStd, SurtidoTraspasoPiezas.this);
        SacaExtrasIntent();
        declararVariables();
        agregaListeners();
...
//        });
        ...
        edtx_ConfirmarEmpaque.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    new esconderTeclado(SurtidoTraspasoPiezas.this);
                    return true;
                }
                return false;
            }
    ...
    private class SegundoPlano extends AsyncTask<String,Void,Void>
    {
        ...
        cAccesoADatos_Almacen cadEmb = new cAccesoADatos_Almacen(SurtidoTraspasoPiezas.this);
        ...
        protected Void doInBackground(String... params)
        {
            try
            {
                ...
                switch (tarea)
                {
                    ...
                    case "SugiereEmpaque":
                        dao = cadEmb.cad_ConsultaContenedorSugeridoTras(Pedido,Partida);
                        break;

                    case "ConsultaEmpaque":
                        dao = cadEmb.c_ConsultaContenedorSurtidoTras(Pedido,Partida,edtx_Empaque.getText().toString());
                        break;

                    case "RegistrarCant":
                        dao = cadEmb.c_OSSurtirPiezasTras(Pedido,Partida,edtx_Empaque.getText().toString(),edtx_ConfirmarEmpaque.getText().toString(),txtv_PalletAbierto.getText().toString());
                        break;

                    case "RegistrarSKU":
                        dao = cadEmb.c_OSSurtirPiezasSKUTras(Pedido,Partida,edtx_Empaque.getText().toString(),edtx_ConfirmarEmpaque.getText().toString(),txtv_PalletAbierto.getText().toString());
                        break;

                    case "CancelarReg":
                        dao = cadEmb.c_OSCancelarSurtPiezasTras(Pedido,Partida,edtx_Empaque.getText().toString(),String.valueOf(intPiezas),txtv_PalletAbierto.getText().toString());
                        break;
                ...
                if (dao.iscEstado())
                {
                    switch (tarea)
                    {
                        case"ConsultaPedidoSurtido":
                            ...
                            {
                                sp_partidas.setAdapter(new CustomArrayAdapter(SurtidoTraspasoPiezas.this,
                        ...
                        case "ConsultaPalletAbierto":
                            if(dao.getcTablaUnica()!=null)
                            {
                                if(ConfigTabla == null)
                                {
                                    ConfigTabla =  new TableViewDataConfigurator(tabla_Salidas, dao, SurtidoTraspasoPiezas.this);
