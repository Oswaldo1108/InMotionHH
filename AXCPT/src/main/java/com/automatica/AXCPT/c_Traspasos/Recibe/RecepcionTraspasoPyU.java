...
public class RecepcionTraspasoPyU extends AppCompatActivity implements  frgmnt_taskbar_AXC.interfazTaskbar, frgmnt_SKU_Conteo.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            new RecepcionTraspasoPyU.SegundoPlano("Tabla").execute();
...
//                {
                    new RecepcionTraspasoPyU.SegundoPlano("DetallePartida").execute();
//                }
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try{
                ...
                switch (tarea)
                {
                    ...
                    case"DetallePartida":
                        dao = cad.cad_DetallePartidaTraspaso(OrdenCompra,binding.txtvPartida.getText().toString());
                        break;
                    ...
                    case "RegistrarEmpaqueNuevo":
                        ...
                        dao = cad.cad_PrimeraUltimaTraspaso(OrdenCompra,
                    ...
                    switch (tarea)
                    {
                        ...
                        case"Tabla":
                            if(dao.getcTablas() != null)
                            {
                                ...
                                sp_Partidas.setAdapter(c = new CustomArrayAdapter(RecepcionTraspasoPyU.this,
                        ...
                        case"DetallePartida":
                            ...
                            binding.txtvProd.setText(dao.getSoapObject_parced().getPrimitivePropertyAsString("Descripcion"));
