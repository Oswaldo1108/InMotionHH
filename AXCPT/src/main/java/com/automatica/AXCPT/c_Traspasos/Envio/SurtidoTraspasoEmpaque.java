...
import com.automatica.AXCPT.databinding.ActivitySurtidoTraspasoEmpaqueBinding;
...
public class SurtidoTraspasoEmpaque  extends AppCompatActivity implements TableViewDataConfigurator.TableClickInterface, frgmnt_taskbar_AXC.interfazTaskbar {

    private Toolbar toolbar;
    private EditText edtx_Empaque, edtx_ConfirmarEmpaque;
    private ActivitySurtidoProdEmpaqueBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try {
            ...
            binding = ActivitySurtidoProdEmpaqueBinding.inflate(getLayoutInflater());
            setContentView(binding.getRoot());
            new cambiaColorStatusBar(contexto, R.color.MoradoStd, SurtidoTraspasoEmpaque .this);
            SacaExtrasIntent();
            declararVariables();
            agregaListeners();
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    if(!edtx_ConfirmarEmpaque.getText().toString().equals(""))
                    {
                        ...
                        new SurtidoTraspasoEmpaque.SegundoPlano("RegistrarEmpaque").execute();
                    }else
                    {
                        handler.post(new Runnable()
                        {
                    ...
                    new esconderTeclado(SurtidoTraspasoEmpaque.this);
                    return true;
                }
                return false;
            }
    ...
    public void BotonDerecha()
    {
        ...
        new CreaDialogos(getString(R.string.pregunta_cierre_pallet),
                new DialogInterface.OnClickListener()
                {
                    ...
                    {
                        new SurtidoTraspasoEmpaque.SegundoPlano("CerrarTarima").execute();
                    }
                },null,contexto);
    }
    ...
    private class SegundoPlano extends AsyncTask<String,Void,Void>
    {
        ...
        cAccesoADatos_Almacen cadEmb = new cAccesoADatos_Almacen(SurtidoTraspasoEmpaque.this);
        ...
        protected Void doInBackground(String... params)
        {
            try
            {
                ...
                switch (tarea)
                {
                    ...
                    case "SugiereEmpaque":
                        dao = cadEmb.cad_ConsultaEmpaqueTrasSugerido(Pedido,Partida);
                        break;

                    case "ConsultaEmpaque":
                        dao = cadEmb.cad_ConsultaEmpaqueSurtidoTras(Pedido,Partida,edtx_Empaque.getText().toString());
                        break;

                    case "RegistrarEmpaque":

                        dao = cadEmb.cad_RegistroEmpaqueSurtidoTras(Pedido,Partida,edtx_Empaque.getText().toString(),tmpCarrito);
                    ...
                    case "ConsultaPalletAbierto":
                        ...
                        dao = cadEmb.cad_ConsultaTarimaConsolidadaTras(Pedido,tmpCarrito);
                    ...
                    switch (tarea)
                    {
                        case"ConsultaPedidoSurtido":
                            if(dao.getcTablas() != null)
                            {
                                ...
                                sp_partidas.setAdapter(c = new CustomArrayAdapter(SurtidoTraspasoEmpaque.this,
                        ...
                        case "ConsultaPedidoDet":
                            ...
                            new SurtidoTraspasoEmpaque.SegundoPlano("SugiereEmpaque").execute();
                            break;
                        ...
                        case "SugiereEmpaque":
                            ...
                            new SurtidoTraspasoEmpaque.SegundoPlano("ConsultaPalletAbierto").execute();
                            ...
                            if(dao.getcTablaUnica()!=null)
                            {
                                if(ConfigTabla == null)
                                {
                                    ConfigTabla =  new TableViewDataConfigurator(2,"Listo",
                                            "En proceso","-",tabla_Salidas, dao, SurtidoTraspasoEmpaque.this);
                                }else
                                {
...
//                                        new SegundoPlano("PalletsArmadoPedido").execute();
                        ...
                        case "RegistrarEmpaque":
                            ...
                            new SurtidoTraspasoEmpaque.SegundoPlano("ConsultaPedidoDet").execute(((Constructor_Dato) sp_partidas.getSelectedItem()).getDato());
                ...
                else
                {
                    ...
                    if(dao.getcMensaje().contains("SURTIDA")||dao.getcMensaje().contains("Estatus de partida no "))
                    {
                        ...
                        new SurtidoTraspasoEmpaque.SegundoPlano("ConsultaPedidoSurtido").execute();
                    }
                    else
                    {
