...
public class SurtidoTraspasoPallet extends AppCompatActivity implements TableViewDataConfigurator.TableClickInterface, frgmnt_taskbar_AXC.interfazTaskbar{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try
        {
            ...
            setContentView(R.layout.activity_surtido_tras_pallet);
    ...
    private void agregaListeners()
    {
        ...
        sp_partidas.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            {
                new SurtidoTraspasoPallet.SegundoPlano("ConsultaPedidoDet").execute(((Constructor_Dato) sp_partidas.getSelectedItem()).getDato());
            }
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    if(TipoReg.equals("PartidaUnica"))
                    {
                        ...
                        new SurtidoTraspasoPallet.SegundoPlano("RegistrarPallet").execute();
                    }
                    else if(TipoReg.equals("MultiplesPartidas"))
                    {
                        Log.i("TipoReg","MultiplesPartidas");
                        new SurtidoTraspasoPallet.SegundoPlano("RegistrarPalletMultPart").execute();
                    }
                    else
                    {
                        new com.automatica.AXCPT.Servicios.popUpGenerico(contexto,getCurrentFocus() ,"Consulte la tarima antes de registrar." ,false ,true , true);
                    ...
                    new esconderTeclado(SurtidoTraspasoPallet.this);
                    return true;
                }
                return false;
            }
        ...
        edtx_Pallet.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    if(!edtx_Pallet.getText().toString().equals(""))
                    {
                        new SurtidoTraspasoPallet.SegundoPlano("ConsultaPallet").execute();
                    }else
                    {
                        new com.automatica.AXCPT.Servicios.popUpGenerico(contexto,getCurrentFocus() ,getString(R.string.error_ingrese_pallet) ,"false" ,true , true);
    ...
    private class SegundoPlano extends AsyncTask<String,Void,Void>
    {
        ...
        cAccesoADatos_Almacen cadEmb = new cAccesoADatos_Almacen(SurtidoTraspasoPallet.this);
        ...
        protected Void doInBackground(String... params)
        {
            try
            {
                ...
                switch (tarea)
                {
                    ...
                    case "SugierePallet":
                        dao = cadEmb.cad_ConsultaPalletSugeridoTras(Pedido,Partida);
                        break;

                    case "ConsultaPallet":
                        dao = cadEmb.cad_ConsultaPalletSurtidoTras(Pedido,Partida,edtx_Pallet.getText().toString());
                        break;

                    case "RegistrarPallet":
                        dao = cadEmb.cad_RegistroPalletSurtidoTras(Pedido,Partida,edtx_ConfirmarPallet.getText().toString());
                        break;
                    case "RegistrarPalletMultPart":
                        dao = cadEmb.cad_RegistroPalletSurtidoTrasMultPart(Pedido,edtx_ConfirmarPallet.getText().toString());
                        break;
                    default:
                ...
                if (dao.iscEstado())
                {
                    switch (tarea)
                    {
                        case"ConsultaPedidoSurtido":
                            ...
                            {
                                sp_partidas.setAdapter(new CustomArrayAdapter(SurtidoTraspasoPallet.this,
                        ...
                        case "ConsultaPedidoDet":
                            ...
                            new SurtidoTraspasoPallet.SegundoPlano("SugierePallet").execute();
                            break;
                        ...
                        case "ConsultaPallet":
                            if(dao.getcTablaUnica()!=null)
                            {
                                if(ConfigTabla == null)
                                {
                                    ConfigTabla =  new TableViewDataConfigurator(tabla, dao, SurtidoTraspasoPallet.this);
                                }else
                                {
                        ...
                        case "RegistrarPallet":
                            ...
                            new SurtidoTraspasoPallet.SegundoPlano("ConsultaPedidoDet").execute("@");
