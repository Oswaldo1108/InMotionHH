...
public class Recepcion_Registro_Transferencias_Por_Empaque extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try {
            ...
            new cambiaColorStatusBar(contexto, R.color.doradoLetrastd, Recepcion_Registro_Transferencias_Por_Empaque.this);
            SacaExtrasIntent();
            declararVariables();
            AgregaListeners();

            Thread.setDefaultUncaughtExceptionHandler(new CustomExceptionHandler(Recepcion_Registro_Transferencias_Por_Empaque.this));
...
//            });
    ...
    private class SegundoPlano extends AsyncTask<Void,Void,Void>
    {
        ...
        cAccesoADatos_Transferencia cad = new cAccesoADatos_Transferencia(Recepcion_Registro_Transferencias_Por_Empaque.this);
            ...
            try {
                switch (tarea)
                    ...
                    case "RegistrarEmpaqueNuevo":
                     ...
                     /*   dao = cad.cad_RegistraEmpaqueTraspaso(Transferencia,
                                                            PartidaERP,
