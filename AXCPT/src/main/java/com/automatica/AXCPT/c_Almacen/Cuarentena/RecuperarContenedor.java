...
import com.automatica.AXCPT.databinding.ActivityRecuperarContenedorBinding;
import com.automatica.axc_lib.AccesoDatos.MetodosConexion.cAccesoADatos_Almacen;
import com.automatica.axc_lib.AccesoDatos.ObjetosConexion.DataAccessObject;

public class RecuperarContenedor extends AppCompatActivity implements frgmnt_taskbar_AXC.interfazTaskbar {

    Context contexto = RecuperarContenedor.this;
    private ProgressBarHelper p;
    ActivityRecuperarContenedorBinding binding;
    Toolbar toolbar;
    popUpGenerico pop = new popUpGenerico(RecuperarContenedor.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityRecuperarContenedorBinding.inflate(getLayoutInflater());
        ...
        try{
            ...
            activityHelpers.AgregarMenu(RecuperarContenedor.this,R.id.Pantalla_principal);
            activityHelpers.AgregarTaskBar(RecuperarContenedor.this,R.id.Pantalla_principal,false);
            DeclararVariables();
            AgregarListeners();
            ...
            try{
                switch (Tarea){
                    ...
                    case "CuarentenaEmpaque":
                        dao = ca.cMoverContenedorADisponible((edtxEmpaque.getText().toString()),etUbicacion.getText().toString());
                        break;
                }
            }catch (Exception e){
                e.printStackTrace();
                ...
                if(dao.iscEstado()){
                    ...
                    switch (Tarea){
                        ...
                        case "CuarentenaEmpaque":
                            ...
                            mediaPlayer.start();
                            Reinicio();
                            new esconderTeclado(RecuperarContenedor.this);
                            break;
                    }
