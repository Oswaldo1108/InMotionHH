...
import com.automatica.AXCPT.databinding.ActivityReubicarContenedorBinding;
...
public class ReubicarContenedor extends AppCompatActivity implements frgmnt_taskbar_AXC.interfazTaskbar {

    ActivityReubicarContenedorBinding binding;
    frgmnt_taskbar_AXC taskbar_axc;
    cAccesoADatos_Almacen ca;
    TextView txtv_Producto, txtv_Cantidad, txtv_Ubicacion,txtv_DescProd,txtv_Estatus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityReubicarContenedorBinding.inflate(getLayoutInflater());
        ...
        declararVariables();
        ca= new cAccesoADatos_Almacen(ReubicarContenedor.this);
        agregaListeners();
        edtx_CodigoPallet.requestFocus();
        new cambiaColorStatusBar(contexto, R.color.doradoLetrastd, ReubicarContenedor.this);
    ...
    private void declararVariables()
    {
        try
        {
            Toolbar toolbar = findViewById(R.id.toolbar);
            setSupportActionBar(toolbar);
            this.getSupportActionBar().setTitle("Reubicar Contenedor");
//        toolbar.setLogo(R.mipmap.logo_axc);//      toolbar.setLogo(R.drawable.axc_logo_toolbar);
        ...
        edtx_CodigoPallet.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    new esconderTeclado(ReubicarContenedor.this);
                }
                return false;
            }
        });
    ...
    private class SegundoPlano extends AsyncTask<Void,Void,Void>
    {
        ...
        cAccesoADatos_Recepcion cacon = new cAccesoADatos_Recepcion(ReubicarContenedor.this);
            ...
            try
            {
                switch (tarea)
                {
                    case "ConsultaPallet":
                        ...
                        dao= cacon.cConsultaContenedor(edtx_CodigoPallet.getText().toString());
                        break;
                    case "RegistroNuevaUbicacion":
                        //sa.SOAPReubicarEmbalaje(CodigoPallet, NuevaUbicacion, contexto);
                        dao = ca.c_ReubicarCont(edtx_CodigoPallet.getText().toString(), edtx_NuevaUbicacion.getText().toString());
                        break;
                    default:
            ...
            try
            {
                if (dao.iscEstado())
                {
                    switch (tarea)
                    {
                        ...
                        case "RegistroNuevaUbicacion":
                            borrarDatos();
                            new popUpGenerico(contexto, getCurrentFocus(), getString(R.string.contenedor_reubicado_exito), String.valueOf(dao.iscEstado()), true, true);
                            break;
