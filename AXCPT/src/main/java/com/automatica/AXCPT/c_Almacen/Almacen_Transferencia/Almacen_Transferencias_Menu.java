    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ListaAlmacen.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                {
                    case 0:
                        intent = new Intent(Almacen_Transferencias_Menu.this, Alm_Registro_Seleccion_Lote.class);
                        break;
                    case 1:
                        intent = new Intent(Almacen_Transferencias_Menu.this, Rec_Registro_Seleccion_Lote.class);
                        break;
