...
import com.automatica.AXCPT.databinding.ActivityCuarentenaPalletBinding;
import com.automatica.axc_lib.AccesoDatos.MetodosConexion.cAccesoADatos_Almacen;
import com.automatica.axc_lib.AccesoDatos.ObjetosConexion.DataAccessObject;
import com.automatica.axc_lib.Servicios.popUpGenerico;

public class CuarentenaPallet extends AppCompatActivity implements frgmnt_taskbar_AXC.interfazTaskbar{

    Context contexto = CuarentenaPallet.this;

    private ProgressBarHelper p;
    ActivityCuarentenaPalletBinding binding;
    Toolbar toolbar;
    popUpGenerico pop = new popUpGenerico(CuarentenaPallet.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCuarentenaPalletBinding.inflate(getLayoutInflater());
        ...
        try{
            ...
            activityHelpers.AgregarMenu(CuarentenaPallet.this,R.id.Pantalla_principal);
            activityHelpers.AgregarTaskBar(CuarentenaPallet.this,R.id.Pantalla_principal,false);
            ...
            try{
                switch (Tarea){
                    ...
                    case "CuarentenaPallet":
                        dao = ca.cMoverPalletACuarentena((edtxEmpaque.getText().toString()),etUbicacion.getText().toString());
                        break;
                }
            }catch (Exception e){
                e.printStackTrace();
                ...
                if(dao.iscEstado()){
                    ...
                    switch (Tarea){
                        ...
                        case "CuarentenaPallet":
                            ...
                            mediaPlayer.start();
                            Reinicio();
                            new esconderTeclado(CuarentenaPallet.this);
                            break;
                    }
