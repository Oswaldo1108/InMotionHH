...
public class Surtido_Traspaso_Picking_NE extends AppCompatActivity implements TableViewDataConfigurator.TableClickInterface
{
    //region variables
   private Toolbar toolbar;
   private EditText edtx_Pallet, edtx_CantidadEmpaques;
   private TextView txtv_Pedido, txtv_Producto, txtv_CantPend, txtv_CantReg,txtv_CantXEmp, txtv_SugLote, txtv_SugPosicion, txtv_ConsProd, txtv_ConsLote, txtv_ConsCant, txtv_ConsEstatus, txtv_SugEmpaque, txtv_PalletAbierto,txtv_ConsUM;
   private String RegEmpPalletAbierto;
   private Button btn_CerrarTarima;
   private ProgressBarHelper progressBarHelper;
   private Context contexto = this;
   private String Documento, Partida, NumParte;
   ...
   private TableViewDataConfigurator ConfigTabla = null;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.traspaso_surtido_picking_ne);
        new cambiaColorStatusBar(contexto, R.color.MoradoStd, Surtido_Traspaso_Picking_NE.this);
        SacaExtrasIntent();
        declararVariables();
        agregaListeners();
    ...
    private void declararVariables()
    {
        try
        {
            ...
            getSupportActionBar().setSubtitle("Picking No Et.");
        ...
        edtx_CantidadEmpaques.setOnKeyListener(new View.OnKeyListener()
        {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    new esconderTeclado(Surtido_Traspaso_Picking_NE.this);
                    return true;
                }
                return false;
            }
    ...
    private class SegundoPlano extends AsyncTask<String,Void,Void>
    {
        ...
        cAccesoADatos_Transferencia cad = new cAccesoADatos_Transferencia(Surtido_Traspaso_Picking_NE.this);
        ...
        protected Void doInBackground(String... params)
        {
            try
            {
                ...
                switch (tarea)
                {
                    ...
                    case "SugiereEmpaque":
                        dao = cad.cad_ConsultaPisoSugeridoTraspaso(Documento,Partida);
                        break;

                    case "ConsultaEmpaque":
                        dao = cad.c_ConsultarPisoTraspaso(Documento,Partida,edtx_Pallet.getText().toString());
                        break;

                    case "RegistrarEmpaque":
                        dao = cad.cad_RegistroTraspasoPisoEnvio(Documento,Partida,edtx_Pallet.getText().toString(),edtx_CantidadEmpaques.getText().toString());
                        break;
                ...
                if (dao.iscEstado())
                {
                    switch (tarea)
                    {
                        case"ConsultaPedidoSurtido":
                            ...
                            {
                                sp_partidas.setAdapter(new CustomArrayAdapter(Surtido_Traspaso_Picking_NE.this,
                        ...
                        case "ConsultaPalletAbierto":
                            if(dao.getcTablaUnica()!=null)
                            {
                                if(ConfigTabla == null)
                                {
                                    ConfigTabla =  new TableViewDataConfigurator(tabla_Salidas, dao, Surtido_Traspaso_Picking_NE.this);
                                }else
                                {
