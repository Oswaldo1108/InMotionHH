...
public class Recepcion_Registro_Transferencia_PrimeraYUltima  extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try {
            ...
            new cambiaColorStatusBar(contexto, R.color.doradoLetrastd, Recepcion_Registro_Transferencia_PrimeraYUltima.this);
            SacaExtrasIntent();
            declararVariables();
            AgregaListeners();
...
//            txtv_Caducidad.setText(FechaCaducidad);
    ...
    private class SegundoPlano extends AsyncTask<Void,Void,Void>
    {
        ...
        cAccesoADatos_Transferencia cad = new cAccesoADatos_Transferencia(Recepcion_Registro_Transferencia_PrimeraYUltima.this);
