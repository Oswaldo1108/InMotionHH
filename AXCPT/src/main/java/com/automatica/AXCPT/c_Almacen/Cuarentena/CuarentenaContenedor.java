...
import com.automatica.AXCPT.databinding.ActivityCuarentenaContenedorBinding;
import com.automatica.axc_lib.AccesoDatos.MetodosConexion.cAccesoADatos_Almacen;
import com.automatica.axc_lib.AccesoDatos.ObjetosConexion.DataAccessObject;
import com.automatica.axc_lib.Servicios.popUpGenerico;

public class CuarentenaContenedor extends AppCompatActivity implements frgmnt_taskbar_AXC.interfazTaskbar {

    Context contexto = CuarentenaContenedor.this;

    private ProgressBarHelper p;
    ActivityCuarentenaContenedorBinding binding;
    Toolbar toolbar;
    popUpGenerico pop = new popUpGenerico(CuarentenaContenedor.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCuarentenaContenedorBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        p = new ProgressBarHelper(this);

        activityHelpers = new ActivityHelpers();
        activityHelpers.AgregarMenu(CuarentenaContenedor.this,R.id.Pantalla_principal);
        activityHelpers.AgregarTaskBar(CuarentenaContenedor.this,R.id.Pantalla_principal,false);
        try{
        ...
        edtxEmpaque.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if(TextUtils.isEmpty(edtxEmpaque.getText())){
                    pop.popUpGenericoDefault(getCurrentFocus(),"Debe escanear un código de contenedor",false);
                }else{
        ...
        etUbicacion.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                ...
                if(TextUtils.isEmpty(etUbicacion.getText())){
                    pop.popUpGenericoDefault(etUbicacion,"Ingrese una posición",false);
                }else {
                    if(TextUtils.isEmpty(edtxEmpaque.getText())){
                        pop.popUpGenericoDefault(edtxEmpaque,"Debe escanear un código de contenedor",false);
                    }else{
            ...
            try{
                switch (Tarea){
                    case "ConsultaEmpaque":
                        dao = ca.cConsultaContenedor(edtxEmpaque.getText().toString());
                        break;

                    case "CuarentenaEmpaque":
                        dao = ca.cMoverContenedorACuarentena(edtxEmpaque.getText().toString(),etUbicacion.getText().toString());
                        break;
                }
            }catch (Exception e){
                e.printStackTrace();
