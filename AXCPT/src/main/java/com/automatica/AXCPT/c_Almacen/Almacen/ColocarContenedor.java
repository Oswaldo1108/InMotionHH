...
import com.automatica.AXCPT.databinding.ActivityColocarContenedorBinding;
...
public class ColocarContenedor extends AppCompatActivity implements frgmnt_taskbar_AXC.interfazTaskbar{

    popUpGenerico pop = new popUpGenerico(ColocarContenedor.this);
    ActivityColocarContenedorBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try{
            ...
            binding = ActivityColocarContenedorBinding.inflate(getLayoutInflater());
            ...
            new cambiaColorStatusBar(contexto, R.color.doradoLetrastd, ColocarContenedor.this);
            declararVariables();
            agregaListeners();
        }catch (Exception e){
            e.printStackTrace();
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    ...
                    }else
                    {
                        ...
                        new popUpGenerico(contexto,vista,getString(R.string.error_ingrese_contenedor),"false",true,true);
                    }
                    new esconderTeclado(ColocarContenedor.this);
                }
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event)
            {
                if((event.getAction()==KeyEvent.ACTION_DOWN)&&(keyCode==KeyEvent.KEYCODE_ENTER))
                {
                    if(!edtx_CodigoUbicacion.getText().toString().equals(""))
                    {
                        ...
                        if(edtx_CodigoPallet.getText().toString().equals(""))
                        {
                            new popUpGenerico(contexto,getCurrentFocus(),getString(R.string.error_ingrese_contenedor),"false",true,true);
                            return false;
                        }
    ...
    private class SegundoPlano extends AsyncTask<Void,Void,Void>
    {
        ...
        cAccesoADatos_Almacen ca = new cAccesoADatos_Almacen(ColocarContenedor.this);
        cAccesoADatos_Recepcion caCons = new cAccesoADatos_Recepcion(ColocarContenedor.this);
            ...
            try
            {
                ...
                switch (tarea) {
                    case "ConsultaPallet":
                        ...
                        dao = caCons.cConsultaContenedor(edtx_CodigoPallet.getText().toString());
                        break;
                    case "ConsultaUbicacionSugerida":

                        dao = ca.c_SugierePosicionCont(edtx_CodigoPallet.getText().toString());
                ...
                if (dao.iscEstado())
                {
                    switch (tarea)
                    {
                        case "ConsultaPallet":
                            ...
                            txtv_Producto.setText(dao.getSoapObject_parced().getPrimitivePropertyAsString("CodigoPallet"));
//                            txtv_DescProd.setText( dao.getSoapObject_parced().getPrimitivePropertyAsString("DescProd"));
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(ColocarContenedor.this, Inicio_Menu_Dinamico.class);
