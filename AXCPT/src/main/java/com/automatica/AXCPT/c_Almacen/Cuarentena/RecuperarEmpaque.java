...
public class RecuperarEmpaque extends AppCompatActivity implements frgmnt_taskbar_AXC.interfazTaskbar{
    Context contexto = RecuperarEmpaque.this;
    private ActivityHelpers activityHelpers;
    private ProgressBarHelper p;
    ActivityRecuperarEmpaqueBinding binding;
    Toolbar toolbar;
    popUpGenerico pop = new popUpGenerico(RecuperarEmpaque.this);
   ...
   MediaPlayer mediaPlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityRecuperarEmpaqueBinding.inflate(getLayoutInflater());
        ...
        try{
            ...
            activityHelpers.AgregarMenu(RecuperarEmpaque.this,R.id.Pantalla_principal);
            activityHelpers.AgregarTaskBar(RecuperarEmpaque.this,R.id.Pantalla_principal,false);
            DeclararVariables();
            AgregarListeners();
            ...
            try{
                switch (Tarea){
                    ...
                    case "CuarentenaEmpaque":
                        dao = ca.cMoverEmpaqueADisponible((edtxEmpaque.getText().toString()),etUbicacion.getText().toString());
                        break;
                }
            }catch (Exception e){
                e.printStackTrace();
                ...
                if(dao.iscEstado()){
                    ...
                    switch (Tarea){
                        ...
                        case "CuarentenaEmpaque":
                            ...
                            mediaPlayer.start();
                            Reinicio();
                            new esconderTeclado(RecuperarEmpaque.this);
                            break;
                    }
