 ...
 * @author ISchwarz
 */
public class StandarDataAdapter extends TableDataAdapter<String[]> {
    ...
    public StandarDataAdapter(final Context context, final String[][] data) {
        super(context, data);
    }

    public StandarDataAdapter(final Context context, final List<String[]> data) {
        super(context, data);
    }
