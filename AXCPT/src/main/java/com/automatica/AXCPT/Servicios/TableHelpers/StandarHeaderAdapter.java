...
/**
 * Implementacion simple del adaptador para las tablas. {@link TableHeaderAdapter}. This adapter will render the given header
 * Strings as {@link TextView}.
 *
 * @author David
 * Este adaptador pone el texto en color blanco.
 */
public final class StandarHeaderAdapter extends TableHeaderAdapter {
     ...
     */
    public StandarHeaderAdapter(final Context context, final String... headers) {
        super(context);
        this.headers = headers;
    }

    public StandarHeaderAdapter(final Context context, final int... headerStringResources) {
        super(context);
