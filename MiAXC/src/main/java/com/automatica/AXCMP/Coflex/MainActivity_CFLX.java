package com.automatica.AXCMP.Coflex;
...
import com.automatica.AXCMP.Coflex.Liberaciones_CFLX.LiberacionOC.act_MiAXC_Liberacion_OrdenCompra_cflx;
import com.automatica.AXCMP.Coflex.Liberaciones_CFLX.act_MiAXC_Liberacion_Orden_Surtido;
...
import com.automatica.AXCMP.MiAXC.ConsultaReferencia.act_MiAXC_ConsultaReferencia;
import com.automatica.AXCMP.MiAXC.ConsultaTransacciones.act_MiAXC_ConsultaTransacciones;
import com.automatica.AXCMP.MiAXC.Consulta_Documentos;
import com.automatica.AXCMP.MiAXC.Consulta_Documentos_OC;
import com.automatica.AXCMP.MiAXC.Consulta_Documentos_Tras;
import com.automatica.AXCMP.MiAXC.Consulta_Empaque_Pallet_Det;
import com.automatica.AXCMP.MiAXC.Consulta_Existencias;
import com.automatica.AXCMP.MiAXC.Consulta_Pallets;
import com.automatica.AXCMP.MiAXC.Consulta_Pallets_Sin_Colocar;
import com.automatica.AXCMP.MiAXC.Kardex.act_MiAXC_Kardex;
import com.automatica.AXCMP.MiAXC.fragmento_menu_consultas;
import com.automatica.AXCMP.MiAXC.frgmnt_ConsultaDetalleIncidencia;
import com.automatica.AXCMP.MiAXC.frgmnt_Consulta_Documento_Det;
import com.automatica.AXCMP.MiAXC.frgmnt_Consulta_Documento_Det_Lista;
...
import com.automatica.AXCMP.MiAXC.frgmnt_Consulta_Obj;
import com.automatica.AXCMP.MiAXC.frgmnt_Consulta_Pallet_Det;
import com.automatica.AXCMP.MiAXC.frgmnt_Menu_Inicio;
import com.automatica.AXCMP.MiAXC.frgmnt_Visor_Incidencias_Estaciones;
...
public class MainActivity_CFLX<intro> extends AppCompatActivity
        ...
        try
            {
                ...
                setContentView(R.layout.activity_main_coflex);
                declararVariables();
                agregarListeners();
            ...
            {
                e.printStackTrace();
                new popUpGenerico(MainActivity_CFLX.this, getCurrentFocus(), e.getMessage(), false, true,true);
            }
...
//          }
        ...
        if (fragment != null)
            {
                MainActivity_CFLX.this.getSupportFragmentManager().beginTransaction().remove(fragment).commit();
                return;
            }
        ...
        switch(id)
            {
                ...
                case R.id.Menu_Reimpresion_Etiquetas:
                    startActivity( new Intent(MainActivity_CFLX.this, act_MiAXC_Impresion_Etiquetas.class));
                break;

                case R.id.Kardex:
                    startActivity(new Intent(MainActivity_CFLX.this, act_MiAXC_Kardex.class));
                    break;

                case R.id.Referencia:
                    startActivity(new Intent(MainActivity_CFLX.this, act_MiAXC_ConsultaReferencia.class));

                    break;

                case R.id.MapaAlmacen:
                    startActivity( new Intent(MainActivity_CFLX.this, act_Mapa_Almacen_CFLX.class));

                    break;

                case R.id.lib_Embarque:
                    startActivity(new Intent(MainActivity_CFLX.this, act_MiAXC_Liberacion_Orden_Surtido.class));

                    break;

                case R.id.lib_Transfer:
                    startActivity(new Intent(MainActivity_CFLX.this, act_MiAXC_Liberacion_Transferencia.class));

                    break;

                case R.id.nav_share:
                    Intent intent = new Intent(MainActivity_CFLX.this, Preferencias_AXC.class);
                ...
                case R.id.Cons_Eb:
                    startActivity(new Intent(MainActivity_CFLX.this, act_MiAXC_Liberacion_OrdenCompra_cflx.class));
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data)
    {
      ...
      if(requestCode == 1001||requestCode == 1002)
          ...
          }else
          {
              ...
              ((Consulta_Empaque_Pallet_Det)(getSupportFragmentManager().findFragmentByTag(frgtag_ConsultaEmpaquePalletDET))).onQRCodeScanResponse(result.getContents());
