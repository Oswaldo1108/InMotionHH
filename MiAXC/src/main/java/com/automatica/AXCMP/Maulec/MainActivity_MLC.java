package com.automatica.AXCMP.Maulec;
...
public class MainActivity_MLC<intro> extends AppCompatActivity
        ...
        fragment_VLC_Cargando.OnFragmentInteractionListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        try
            ...
            {
                e.printStackTrace();
                new popUpGenerico(MainActivity_MLC.this, getCurrentFocus(), e.getMessage(), false, true,true);
            }
...
//                startActivity(new Intent(MainActivity_MLC.this, act_MiAXC_Kardex.class));
...
//          }
        ...
        if (fragment != null)
            {
                MainActivity_MLC.this.getSupportFragmentManager().beginTransaction().remove(fragment).commit();
                return;
            }
        ...
        switch(id)
            {
                ...
                case R.id.Menu_Reimpresion_Etiquetas:
                    startActivity( new Intent(MainActivity_MLC.this, act_MiAXC_Impresion_Etiquetas.class));
                ...
                case R.id.Kardex:
                    startActivity(new Intent(MainActivity_MLC.this, act_MiAXC_ConsultaTransacciones.class));
                    break;
                ...
                case R.id.MapaAlmacen:
                    startActivity( new Intent(MainActivity_MLC.this, act_Mapa_Almacen.class));

                    break;
                case R.id.nav_share:
                    startActivity( new Intent(MainActivity_MLC.this, Preferencias_AXC.class));


                    break;

                case R.id.lib_Embarque:
                    startActivity(new Intent(MainActivity_MLC.this, act_MiAXC_Liberacion_Embarque.class));

                    break;
                case R.id.lib_Transfer:
                    startActivity(new Intent(MainActivity_MLC.this, act_MiAXC_Liberacion_Transferencia.class));

                    break;

//                case R.id.Cons_Eb:
//                    startActivity(new Intent(MainActivity_MLC.this, act_MiAXC_Liberacion_OrdenCompra.class));
//
//                    break;
