package com.automatica.AXCMP.Liberaciones.LiberacionOrdenCompra;
...
import com.automatica.AXCMP.Coflex.Liberaciones_CFLX.LiberacionOC.frgmnt_Seleccion_Lotes_CFLX;
...
public class act_MiAXC_Liberacion_OrdenCompra extends AppCompatActivity
...

{
    ...
    EditText edtx_Documento,edtx_Proveedor,edtx_Factura,edtx_Referencia,edtx_FechaCrea,edtx_FechaRecibo,edtx_FechaRequerida;
//    EditText edtx_Total,edtx_Moneda,edtx_TipoCambio,edtx_ClavePedimento,edtx_NumeroAgenteAduanal,edtx_NumeroPedimento,edtx_FechaPedimento;
    ...
    Button btn_LiberarEmbarque,btn_LiberarEmbarqueSAP;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.act_miaxc_liberacion_orden_compra);
        declararVariables();
        agregaListeners();
//        toolbar.setSubtitle("Kardex");
        ...
        new esconderTeclado(act_MiAXC_Liberacion_OrdenCompra.this);
...
//        getSupportActionBar().setLogo(null);
        getSupportActionBar().setTitle("Liberación de Órden de compra");
        getSupportActionBar().setSubtitle("Para actualizar las órdenes, toque el botón de actualizar a la derecha.");
        ...
        edtx_FechaRequerida= (EditText) findViewById(R.id.edtx_Embarque13);
...
//        edtx_FechaPedimento= (EditText) findViewById(R.id.edtx_Embarque17);
        ...
        btn_LiberarEmbarqueSAP = (Button) findViewById(R.id.btn_LiberarEmbarque5);
    ...
    private void agregaListeners()
    {
        ...
        edtx_FechaRequerida.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                try
                    {
                        ...
                        newFragment = DatePickerFragment.newInstance(
                                new DatePickerDialog.OnDateSetListener()
                                {
                                    ...
                                    {
                                        final String selectedDate = day + "/" + (month + 1) + "/" + year;
                                        edtx_FechaRequerida.setText(selectedDate);
                                    }
                                });
...
//                            }
                        ...
                        if(edtx_FechaRequerida.getText().toString().equals(""))
                            {
                                new popUpGenerico(contexto, getCurrentFocus(),"Ingrese fecha de requerida.", false, true, true);
                                return;
                            }
                        ...
                        new CreaDialogos("¿Liberar Embarque?",
...
//                        lanzarConsulta();
        ...
        btn_LiberarEmbarqueSAP.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
...
//                            }
                        ...
                        new CreaDialogos("¿Liberar Embarque con SAP?",
                                new DialogInterface.OnClickListener()
                                {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which)
                                    {
                                        new SegundoPlano("LiberaRecepcionSAP").execute();
...
//                .commit();
    ...
    private class SegundoPlano extends AsyncTask<String,Void,Void>
    {
        ...
        cAccesoADatos ca = new cAccesoADatos(act_MiAXC_Liberacion_OrdenCompra.this);
                            ...
                            switch (tarea)
                                {
                                    ...
                                    case "LiberaRecepcion":
                                        ...
                                        dao = ca.c_LiberaOrdenCompraMiAXC_SIN_SAP(
                                                edtx_Documento.getText().toString(),
                                                ...
                                                edtx_FechaRequerida.getText().toString(),                         //edtx_FechaPedimento.getText().toString(),
                                                arrPartidas,
                                                null,
                                                "0",
                                                "1"
                                        ...
                                        break;
                                    case "LiberaRecepcionSAP":

                                        dao = ca.c_LiberaOrdenCompraMiAXC_CON_SAP(
                                                edtx_Documento.getText().toString(),
                                                edtx_Factura.getText().toString(),
                                                "",                         //edtx_Total.getText().toString(),
                                                "",                         //edtx_TipoCambio.getText().toString(),
