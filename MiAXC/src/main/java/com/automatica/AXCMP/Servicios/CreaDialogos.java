...
public class CreaDialogos
{
        ...
        try {
           Vibrator v = (Vibrator) contexto.getSystemService(VIBRATOR_SERVICE);
            new AlertDialog.Builder(contexto).setIcon(R.drawable.ic_warning_black_24dp)
                    ...
                    .setPositiveButton("Desplegar de nuevo", listenerSi)
                    .setNegativeButton("Cancelar", listenerNo)
                    .show();
            v.vibrate(150);
    ...
    public CreaDialogos(String Titulo, DialogInterface.OnClickListener listenerSi, DialogInterface.OnClickListener listenerNo,String MensajePositivo, Context contexto)
    {
        try
            {
                Vibrator v = (Vibrator) contexto.getSystemService(VIBRATOR_SERVICE);
                new AlertDialog.Builder(contexto).setIcon(R.drawable.ic_warning_black_24dp)
                        ...
                        .setTitle(Titulo).setCancelable(false)
                        .setPositiveButton(MensajePositivo, listenerSi)
                        .setNegativeButton("Cancelar", listenerNo)
                        .show();
                v.vibrate(150);
                MediaPlayer mp = MediaPlayer.create(contexto, R.raw.beep);
