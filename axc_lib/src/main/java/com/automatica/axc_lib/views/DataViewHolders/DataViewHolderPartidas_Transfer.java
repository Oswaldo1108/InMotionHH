...
public  class DataViewHolderPartidas_Transfer extends RecyclerView.ViewHolder
{
  ...
  public EditText edtx_Cantidad, edtx_Lote;

    public DataViewHolderPartidas_Transfer(View itemView)
    {
        super(itemView);
        try
            {
