...
public class Incidencia extends AppCompatActivity
{
    ...
    private ImageButton btn_TomarFoto, btn_Buscar;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        imgv_ = (ImageView) findViewById(R.id.img_Preview);
                        ...
                        if (CameraIntent.resolveActivity(getPackageManager()) != null)
                            {
                                ...
                                if (foto != null)
                                    {
                                        Uri fotoURI = FileProvider.getUriForFile(Incidencia.this, "com.automatica.AXCMP.fileprovider", foto);
                                        ...
                                        if (currentPhotoPath != null)
                                            {
                                               ...
                                               // Log.i("PATH","HOLA "+cr.getSelectedExtra(sp_Modulos.getSelectedItemPosition()));
                                                dao = ca.SOAPIncidencia(sp_Modulos.getSelectedItem().toString(), edtx_DescripcionIncidencia.getText().toString(), streamToBytes(is));
                                                is.close();
                        ...
                        switch (Tarea)
                            {
                                ...
                                case "EnviarIncidencia":
                                    new popUpGenerico(Incidencia.this, getCurrentFocus(), "Incidencia registrada correctamente.", dao.iscEstado(), true, true);
//                                    File f = new File(currentPhotoPath);
